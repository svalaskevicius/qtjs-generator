...
function processCallback(item, data)
{
  ...
  print (">>>> "+item.getLocation()+"\n");
	...
	if(item.getLocation().indexOf('event') >= 0) {		data.skipBind = true;	}
	...
	if(item.getLocation().indexOf('array') >= 0) {		data.skipBind = true;	}
	...
	if(item.getLocation().indexOf('transition') >= 0) {		data.skipBind = true;	}
	...
	if(item.getLocation().indexOf('qstring') >= 0) {		data.skipBind = true;	}
	...
	if(item.getLocation().indexOf('qlogging') >= 0) {		data.skipBind = true;	}
