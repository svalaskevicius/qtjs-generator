...
#ifndef CPGF_META_QTWIDGETS_QCOMMANDLINKBUTTON_H
#define CPGF_META_QTWIDGETS_QCOMMANDLINKBUTTON_H
...
void buildMetaClass_QCommandLinkButton(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _constructor<void * (const QString &, QWidget *)>(cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >())
        ._default(copyVariantFromCopyable(0))
    ;
    _d.CPGF_MD_TEMPLATE _constructor<void * (const QString &, const QString &, QWidget *)>(cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0>, cpgf::GMetaRuleCopyConstReference<1> >())
        ._default(copyVariantFromCopyable(0))
    ;
...
class QCommandLinkButtonWrapper : public QCommandLinkButton, public cpgf::GScriptWrapper {
public:
    ...
    static void cpgf__register(D _d)
    {
        ...
        _d.CPGF_MD_TEMPLATE _method("minimumSizeHint", (QSize (D::ClassType::*) () const)&D::ClassType::minimumSizeHint);
        ...
        _d.CPGF_MD_TEMPLATE _method("sizeHint", (QSize (D::ClassType::*) () const)&D::ClassType::sizeHint);
        ...
        _d.CPGF_MD_TEMPLATE _method("heightForWidth", (int (D::ClassType::*) (int) const)&D::ClassType::heightForWidth);
