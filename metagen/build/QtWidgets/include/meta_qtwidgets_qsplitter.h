...
#ifndef CPGF_META_QTWIDGETS_QSPLITTER_H
#define CPGF_META_QTWIDGETS_QSPLITTER_H
...
void buildMetaClass_Global_qsplitter(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _operator<QTextStream & (*)(QTextStream &, QSplitter &)>(mopHolder >> mopHolder, cpgf::MakePolicy<cpgf::GMetaRuleParamNoncopyable<-1>, cpgf::GMetaRuleParamNoncopyable<0>, cpgf::GMetaRuleParamNoncopyable<1> >());
}
...
void buildMetaClass_QSplitter(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("setChildrenCollapsible", &D::ClassType::setChildrenCollapsible);
    _d.CPGF_MD_TEMPLATE _method("childrenCollapsible", &D::ClassType::childrenCollapsible);
    _d.CPGF_MD_TEMPLATE _method("setCollapsible", &D::ClassType::setCollapsible);
    _d.CPGF_MD_TEMPLATE _method("isCollapsible", &D::ClassType::isCollapsible);
    _d.CPGF_MD_TEMPLATE _method("setOpaqueResize", &D::ClassType::setOpaqueResize)
        ._default(copyVariantFromCopyable(true))
    ;
    _d.CPGF_MD_TEMPLATE _method("opaqueResize", &D::ClassType::opaqueResize);
    ...
    _d.CPGF_MD_TEMPLATE _method("sizes", &D::ClassType::sizes);
    _d.CPGF_MD_TEMPLATE _method("setSizes", &D::ClassType::setSizes);
    ...
    _d.CPGF_MD_TEMPLATE _method("handleWidth", &D::ClassType::handleWidth);
    _d.CPGF_MD_TEMPLATE _method("setHandleWidth", &D::ClassType::setHandleWidth);
    ...
    _d.CPGF_MD_TEMPLATE _method("getRange", &D::ClassType::getRange);
    ...
    _d.CPGF_MD_TEMPLATE _method("splitterMoved", &D::ClassType::splitterMoved);
...
class QSplitterWrapper : public QSplitter, public cpgf::GScriptWrapper {
public:
    
    QSplitterWrapper(QWidget * parent = 0)
        : QSplitter(parent) {}
    
    QSplitterWrapper(Qt::Orientation __arg0, QWidget * parent = 0)
        : QSplitter(__arg0, parent) {}
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QSplitter::qt_metacast(__arg0);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QSplitter::qt_metacall(__arg0, __arg1, __arg2);
    }
    ...
    {
        cpgf::GScopedInterface<cpgf::IScriptFunction> func(this->getScriptFunction("createHandle"));
        if(func)
        {
            return cpgf::fromVariant<QSplitterHandle * >(cpgf::invokeScriptFunctionOnObject(func.get(), this).getValue());
        }
        return QSplitter::createHandle();
    }
    QSplitterHandle * super_createHandle()
    {
        return QSplitter::createHandle();
    }
    ...
    int closestLegalPosition(int __arg0, int __arg1)
    {
        return QSplitter::closestLegalPosition(__arg0, __arg1);
    }
    ...
    static void cpgf__register(D _d)
    {
        ...
        _d.CPGF_MD_TEMPLATE _method("setRubberBand", (void (D::ClassType::*) (int))&D::ClassType::setRubberBand);
        ...
        _d.CPGF_MD_TEMPLATE _method("createHandle", (QSplitterHandle * (D::ClassType::*) ())&D::ClassType::createHandle);
        ...
        _d.CPGF_MD_TEMPLATE _method("closestLegalPosition", (int (D::ClassType::*) (int, int))&D::ClassType::closestLegalPosition);
        ...
        _d.CPGF_MD_TEMPLATE _method("moveSplitter", (void (D::ClassType::*) (int, int))&D::ClassType::moveSplitter);
        ...
        _d.CPGF_MD_TEMPLATE _method("super_createHandle", (QSplitterHandle * (D::ClassType::*) ())&D::ClassType::super_createHandle);
...
void buildMetaClass_QSplitterHandle(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("orientation", &D::ClassType::orientation);
    _d.CPGF_MD_TEMPLATE _method("opaqueResize", &D::ClassType::opaqueResize);
    _d.CPGF_MD_TEMPLATE _method("splitter", &D::ClassType::splitter);
    _d.CPGF_MD_TEMPLATE _method("sizeHint", &D::ClassType::sizeHint);
    _d.CPGF_MD_TEMPLATE _method("tr", &D::ClassType::tr)
        ._default(copyVariantFromCopyable(-1))
        ._default(copyVariantFromCopyable(0))
...
class QSplitterHandleWrapper : public QSplitterHandle, public cpgf::GScriptWrapper {
public:
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QSplitterHandle::qt_metacast(__arg0);
    }
    void * super_qt_metacast(const char * __arg0)
    {
        return QSplitterHandle::qt_metacast(__arg0);
    ...
    void resizeEvent(QResizeEvent * __arg0)
    {
        ...
        QSplitterHandle::resizeEvent(__arg0);
    }
    void super_resizeEvent(QResizeEvent * __arg0)
    {
        QSplitterHandle::resizeEvent(__arg0);
    ...
    bool event(QEvent * __arg0)
    {
        ...
        return QSplitterHandle::event(__arg0);
    }
    bool super_event(QEvent * __arg0)
    {
        return QSplitterHandle::event(__arg0);
    ...
    void paintEvent(QPaintEvent * __arg0)
    {
        ...
        QSplitterHandle::paintEvent(__arg0);
    }
    void super_paintEvent(QPaintEvent * __arg0)
    {
        QSplitterHandle::paintEvent(__arg0);
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QSplitterHandle::qt_metacall(__arg0, __arg1, __arg2);
    }
    int super_qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        return QSplitterHandle::qt_metacall(__arg0, __arg1, __arg2);
    ...
    void mouseMoveEvent(QMouseEvent * __arg0)
    {
        ...
        QSplitterHandle::mouseMoveEvent(__arg0);
    }
    void super_mouseMoveEvent(QMouseEvent * __arg0)
    {
        QSplitterHandle::mouseMoveEvent(__arg0);
    ...
    void mousePressEvent(QMouseEvent * __arg0)
    {
        ...
        QSplitterHandle::mousePressEvent(__arg0);
    }
    void super_mousePressEvent(QMouseEvent * __arg0)
    {
        QSplitterHandle::mousePressEvent(__arg0);
    ...
    void mouseReleaseEvent(QMouseEvent * __arg0)
    {
        ...
        QSplitterHandle::mouseReleaseEvent(__arg0);
    }
    void super_mouseReleaseEvent(QMouseEvent * __arg0)
    {
        QSplitterHandle::mouseReleaseEvent(__arg0);
    ...
    static void cpgf__register(D _d)
    {
        ...
        _d.CPGF_MD_TEMPLATE _method("focusNextPrevChild", (bool (D::ClassType::*) (bool))&D::ClassType::focusNextPrevChild);
        _d.CPGF_MD_TEMPLATE _method("childEvent", (void (D::ClassType::*) (QChildEvent *))&D::ClassType::childEvent);
        _d.CPGF_MD_TEMPLATE _method("moveSplitter", (void (D::ClassType::*) (int))&D::ClassType::moveSplitter);
        _d.CPGF_MD_TEMPLATE _method("initPainter", (void (D::ClassType::*) (QPainter *) const)&D::ClassType::initPainter);
        _d.CPGF_MD_TEMPLATE _method("focusPreviousChild", (bool (D::ClassType::*) ())&D::ClassType::focusPreviousChild);
        _d.CPGF_MD_TEMPLATE _method("mouseMoveEvent", (void (D::ClassType::*) (QMouseEvent *))&D::ClassType::mouseMoveEvent);
        _d.CPGF_MD_TEMPLATE _method("keyPressEvent", (void (D::ClassType::*) (QKeyEvent *))&D::ClassType::keyPressEvent);
        ...
        _d.CPGF_MD_TEMPLATE _method("nativeEvent", (bool (D::ClassType::*) (const QByteArray &, void *, long *))&D::ClassType::nativeEvent, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >());
        _d.CPGF_MD_TEMPLATE _method("senderSignalIndex", (int (D::ClassType::*) () const)&D::ClassType::senderSignalIndex);
        _d.CPGF_MD_TEMPLATE _method("closestLegalPosition", (int (D::ClassType::*) (int))&D::ClassType::closestLegalPosition);
        _d.CPGF_MD_TEMPLATE _method("keyReleaseEvent", (void (D::ClassType::*) (QKeyEvent *))&D::ClassType::keyReleaseEvent);
        _d.CPGF_MD_TEMPLATE _method("customEvent", (void (D::ClassType::*) (QEvent *))&D::ClassType::customEvent);
        _d.CPGF_MD_TEMPLATE _method("mouseReleaseEvent", (void (D::ClassType::*) (QMouseEvent *))&D::ClassType::mouseReleaseEvent);
        _d.CPGF_MD_TEMPLATE _method("closeEvent", (void (D::ClassType::*) (QCloseEvent *))&D::ClassType::closeEvent);
