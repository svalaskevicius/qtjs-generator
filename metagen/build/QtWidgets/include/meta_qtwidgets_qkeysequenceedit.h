...
#ifndef __META_QTWIDGETS_QKEYSEQUENCEEDIT_H
#define __META_QTWIDGETS_QKEYSEQUENCEEDIT_H
...
template <typename D>
void buildMetaClass_QKeySequenceEdit(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    ...
    ;
    _d.CPGF_MD_TEMPLATE _constructor<void * (const QKeySequence &, QWidget *)>(cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >())
        ._default(copyVariantFromCopyable(0))
    ;
    ...
    _d.CPGF_MD_TEMPLATE _method("keySequence", &D::ClassType::keySequence);
    _d.CPGF_MD_TEMPLATE _method("setKeySequence", &D::ClassType::setKeySequence, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >());
    _d.CPGF_MD_TEMPLATE _method("clear", &D::ClassType::clear);
    _d.CPGF_MD_TEMPLATE _method("editingFinished", &D::ClassType::editingFinished);
    _d.CPGF_MD_TEMPLATE _method("keySequenceChanged", &D::ClassType::keySequenceChanged, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >());
...
class QKeySequenceEditWrapper : public QKeySequenceEdit, public cpgf::GScriptWrapper {
public:
    
    QKeySequenceEditWrapper(QWidget * parent = 0)
        : QKeySequenceEdit(parent) {}
    
    QKeySequenceEditWrapper(const QKeySequence & keySequence, QWidget * parent = 0)
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QKeySequenceEdit::qt_metacast(__arg0);
    }
    ...
    bool event(QEvent * __arg0)
    {
        ...
        return QKeySequenceEdit::event(__arg0);
    }
    ...
    void timerEvent(QTimerEvent * __arg0)
    {
        ...
        QKeySequenceEdit::timerEvent(__arg0);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QKeySequenceEdit::qt_metacall(__arg0, __arg1, __arg2);
    }
    ...
    void keyPressEvent(QKeyEvent * __arg0)
    {
        ...
        QKeySequenceEdit::keyPressEvent(__arg0);
    }
    ...
    void keyReleaseEvent(QKeyEvent * __arg0)
    {
        ...
        QKeySequenceEdit::keyReleaseEvent(__arg0);
    }
...
template <typename D>
void buildMetaClass_QKeySequenceEditWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    
    QKeySequenceEditWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QKeySequenceEdit<D>(config, _d);
}
