...
#ifndef CPGF_META_QTWIDGETS_QKEYSEQUENCEEDIT_H
#define CPGF_META_QTWIDGETS_QKEYSEQUENCEEDIT_H
...
template <typename D>
void buildMetaClass_QKeySequenceEdit(D _d)
{
    (void)_d;
...
template <typename D>
void buildMetaClass_QKeySequenceEditWrapper(D _d)
{
    (void)_d;
    using namespace cpgf;
    
    
    QKeySequenceEditWrapper::cpgf__register(_d);
    
    buildMetaClass_QKeySequenceEdit<D>(_d);
}
