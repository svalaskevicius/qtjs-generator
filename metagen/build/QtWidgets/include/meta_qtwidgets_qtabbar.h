...
#ifndef CPGF_META_QTWIDGETS_QTABBAR_H
#define CPGF_META_QTWIDGETS_QTABBAR_H
...
void buildMetaClass_QTabBar(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("addTab", (int (D::ClassType::*) (const QString &))&D::ClassType::addTab, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >());
    _d.CPGF_MD_TEMPLATE _method("addTab", (int (D::ClassType::*) (const QIcon &, const QString &))&D::ClassType::addTab, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0>, cpgf::GMetaRuleCopyConstReference<1> >());
    _d.CPGF_MD_TEMPLATE _method("insertTab", (int (D::ClassType::*) (int, const QString &))&D::ClassType::insertTab, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<1> >());
    _d.CPGF_MD_TEMPLATE _method("insertTab", (int (D::ClassType::*) (int, const QIcon &, const QString &))&D::ClassType::insertTab, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<1>, cpgf::GMetaRuleCopyConstReference<2> >());
    _d.CPGF_MD_TEMPLATE _method("removeTab", &D::ClassType::removeTab);
    _d.CPGF_MD_TEMPLATE _method("moveTab", &D::ClassType::moveTab);
    ...
    _d.CPGF_MD_TEMPLATE _method("tabTextColor", &D::ClassType::tabTextColor);
    _d.CPGF_MD_TEMPLATE _method("setTabTextColor", &D::ClassType::setTabTextColor, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<1> >());
    ...
    _d.CPGF_MD_TEMPLATE _method("setTabData", &D::ClassType::setTabData, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<1> >());
    _d.CPGF_MD_TEMPLATE _method("tabData", &D::ClassType::tabData);
    _d.CPGF_MD_TEMPLATE _method("tabRect", &D::ClassType::tabRect);
    _d.CPGF_MD_TEMPLATE _method("tabAt", &D::ClassType::tabAt);
    ...
    _d.CPGF_MD_TEMPLATE _method("setDrawBase", &D::ClassType::setDrawBase);
    _d.CPGF_MD_TEMPLATE _method("drawBase", &D::ClassType::drawBase);
    ...
    _d.CPGF_MD_TEMPLATE _method("setTabButton", &D::ClassType::setTabButton);
    _d.CPGF_MD_TEMPLATE _method("tabButton", &D::ClassType::tabButton);
    _d.CPGF_MD_TEMPLATE _method("selectionBehaviorOnRemove", &D::ClassType::selectionBehaviorOnRemove);
    _d.CPGF_MD_TEMPLATE _method("setSelectionBehaviorOnRemove", &D::ClassType::setSelectionBehaviorOnRemove);
    _d.CPGF_MD_TEMPLATE _method("expanding", &D::ClassType::expanding);
    _d.CPGF_MD_TEMPLATE _method("setExpanding", &D::ClassType::setExpanding);
    ...
    _d.CPGF_MD_TEMPLATE _method("tabMoved", &D::ClassType::tabMoved);
    ...
    _d.CPGF_MD_TEMPLATE _enum<typename D::ClassType::Shape>("Shape")
        ._element("RoundedNorth", D::ClassType::RoundedNorth)
        ._element("RoundedSouth", D::ClassType::RoundedSouth)
        ._element("RoundedWest", D::ClassType::RoundedWest)
        ._element("RoundedEast", D::ClassType::RoundedEast)
        ._element("TriangularNorth", D::ClassType::TriangularNorth)
        ._element("TriangularSouth", D::ClassType::TriangularSouth)
        ._element("TriangularWest", D::ClassType::TriangularWest)
        ._element("TriangularEast", D::ClassType::TriangularEast)
    ;
    _d.CPGF_MD_TEMPLATE _enum<typename D::ClassType::ButtonPosition>("ButtonPosition")
        ._element("LeftSide", D::ClassType::LeftSide)
        ._element("RightSide", D::ClassType::RightSide)
    ;
    _d.CPGF_MD_TEMPLATE _enum<typename D::ClassType::SelectionBehavior>("SelectionBehavior")
        ._element("SelectLeftTab", D::ClassType::SelectLeftTab)
        ._element("SelectRightTab", D::ClassType::SelectRightTab)
        ._element("SelectPreviousTab", D::ClassType::SelectPreviousTab)
    ;
}


class QTabBarWrapper : public QTabBar, public cpgf::GScriptWrapper {
public:
    ...
    {
        cpgf::GScopedInterface<cpgf::IScriptFunction> func(this->getScriptFunction("minimumTabSizeHint"));
        if(func)
        {
    ...
    QSize super_minimumTabSizeHint(int index) const
    {
        return QTabBar::minimumTabSizeHint(index);
    }
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QTabBar::qt_metacast(__arg0);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QTabBar::qt_metacall(__arg0, __arg1, __arg2);
    }
    ...
    {
        cpgf::GScopedInterface<cpgf::IScriptFunction> func(this->getScriptFunction("tabLayoutChange"));
        if(func)
        {
    ...
    void mousePressEvent(QMouseEvent * __arg0)
    {
        ...
        QTabBar::mousePressEvent(__arg0);
    }
    ...
    {
        cpgf::GScopedInterface<cpgf::IScriptFunction> func(this->getScriptFunction("tabSizeHint"));
        if(func)
        {
            return cpgf::fromVariant<QSize >(cpgf::invokeScriptFunctionOnObject(func.get(), this, index).getValue());
        }
    ...
    QSize super_tabSizeHint(int index) const
    {
        return QTabBar::tabSizeHint(index);
    }
    ...
    void mouseReleaseEvent(QMouseEvent * __arg0)
    {
        ...
        QTabBar::mouseReleaseEvent(__arg0);
    }
    ...
    static void cpgf__register(D _d)
    {
        ...
        _d.CPGF_MD_TEMPLATE _method("tabLayoutChange", (void (D::ClassType::*) ())&D::ClassType::tabLayoutChange);
        ...
        _d.CPGF_MD_TEMPLATE _method("tabSizeHint", (QSize (D::ClassType::*) (int) const)&D::ClassType::tabSizeHint);
        _d.CPGF_MD_TEMPLATE _method("keyReleaseEvent", (void (D::ClassType::*) (QKeyEvent *))&D::ClassType::keyReleaseEvent);
        _d.CPGF_MD_TEMPLATE _method("initStyleOption", (void (D::ClassType::*) (QStyleOptionTab *, int) const)&D::ClassType::initStyleOption);
        ...
        _d.CPGF_MD_TEMPLATE _method("super_minimumTabSizeHint", (QSize (D::ClassType::*) (int) const)&D::ClassType::super_minimumTabSizeHint);
        ...
        _d.CPGF_MD_TEMPLATE _method("super_tabLayoutChange", (void (D::ClassType::*) ())&D::ClassType::super_tabLayoutChange);
        ...
        _d.CPGF_MD_TEMPLATE _method("super_tabSizeHint", (QSize (D::ClassType::*) (int) const)&D::ClassType::super_tabSizeHint);
