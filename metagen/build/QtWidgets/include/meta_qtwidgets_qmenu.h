...
#ifndef __META_QTWIDGETS_QMENU_H
#define __META_QTWIDGETS_QMENU_H
...
template <typename D>
void buildMetaClass_QMenu(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("addAction", (QAction * (D::ClassType::*) (const QIcon &, const QString &))&D::ClassType::addAction, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0>, cpgf::GMetaRuleCopyConstReference<1> >());
    _d.CPGF_MD_TEMPLATE _method("addAction", (QAction * (D::ClassType::*) (const QString &, const QObject *, const char *, const QKeySequence &))&D::ClassType::addAction, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0>, cpgf::GMetaRuleCopyConstReference<3> >())
        ._default(copyVariantFromCopyable(0))
    ;
    _d.CPGF_MD_TEMPLATE _method("addAction", (QAction * (D::ClassType::*) (const QIcon &, const QString &, const QObject *, const char *, const QKeySequence &))&D::ClassType::addAction, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0>, cpgf::GMetaRuleCopyConstReference<1>, cpgf::GMetaRuleCopyConstReference<4> >())
        ._default(copyVariantFromCopyable(0))
    ;
    ...
    _d.CPGF_MD_TEMPLATE _method("addSection", (QAction * (D::ClassType::*) (const QString &))&D::ClassType::addSection, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >());
    _d.CPGF_MD_TEMPLATE _method("addSection", (QAction * (D::ClassType::*) (const QIcon &, const QString &))&D::ClassType::addSection, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0>, cpgf::GMetaRuleCopyConstReference<1> >());
    ...
    _d.CPGF_MD_TEMPLATE _method("insertSection", (QAction * (D::ClassType::*) (QAction *, const QString &))&D::ClassType::insertSection, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<1> >());
    _d.CPGF_MD_TEMPLATE _method("insertSection", (QAction * (D::ClassType::*) (QAction *, const QIcon &, const QString &))&D::ClassType::insertSection, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<1>, cpgf::GMetaRuleCopyConstReference<2> >());
    _d.CPGF_MD_TEMPLATE _method("isEmpty", &D::ClassType::isEmpty);
    _d.CPGF_MD_TEMPLATE _method("clear", &D::ClassType::clear);
    _d.CPGF_MD_TEMPLATE _method("setTearOffEnabled", &D::ClassType::setTearOffEnabled);
    _d.CPGF_MD_TEMPLATE _method("isTearOffEnabled", &D::ClassType::isTearOffEnabled);
    _d.CPGF_MD_TEMPLATE _method("isTearOffMenuVisible", &D::ClassType::isTearOffMenuVisible);
    _d.CPGF_MD_TEMPLATE _method("hideTearOffMenu", &D::ClassType::hideTearOffMenu);
    _d.CPGF_MD_TEMPLATE _method("setDefaultAction", &D::ClassType::setDefaultAction);
    _d.CPGF_MD_TEMPLATE _method("defaultAction", &D::ClassType::defaultAction);
    ...
    _d.CPGF_MD_TEMPLATE _method("popup", &D::ClassType::popup)
        ._default(copyVariantFromCopyable(0))
    ;
    _d.CPGF_MD_TEMPLATE _method("exec", (QAction * (D::ClassType::*) ())&D::ClassType::exec);
    _d.CPGF_MD_TEMPLATE _method("exec", (QAction * (D::ClassType::*) (const QPoint &, QAction *))&D::ClassType::exec)
        ._default(copyVariantFromCopyable(0))
    ;
    ...
    _d.CPGF_MD_TEMPLATE _method("menuAction", &D::ClassType::menuAction);
    ...
    _d.CPGF_MD_TEMPLATE _method("setNoReplayFor", &D::ClassType::setNoReplayFor);
    _d.CPGF_MD_TEMPLATE _method("separatorsCollapsible", &D::ClassType::separatorsCollapsible);
    _d.CPGF_MD_TEMPLATE _method("setSeparatorsCollapsible", &D::ClassType::setSeparatorsCollapsible);
    _d.CPGF_MD_TEMPLATE _method("toolTipsVisible", &D::ClassType::toolTipsVisible);
    _d.CPGF_MD_TEMPLATE _method("setToolTipsVisible", &D::ClassType::setToolTipsVisible);
    _d.CPGF_MD_TEMPLATE _method("aboutToShow", &D::ClassType::aboutToShow);
    _d.CPGF_MD_TEMPLATE _method("aboutToHide", &D::ClassType::aboutToHide);
    ...
    _d.CPGF_MD_TEMPLATE _method("tr", &D::ClassType::tr)
        ...
        ._default(copyVariantFromCopyable(0))
    ;
    _d.CPGF_MD_TEMPLATE _method("exec", (QAction * (*) (QList< QAction * >, const QPoint &, QAction *, QWidget *))&D::ClassType::exec)
        ._default(copyVariantFromCopyable(0))
        ._default(copyVariantFromCopyable(0))
    ;
}
...
class QMenuWrapper : public QMenu, public cpgf::GScriptWrapper {
public:
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QMenu::qt_metacast(__arg0);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QMenu::qt_metacall(__arg0, __arg1, __arg2);
    }
    ...
    void mouseReleaseEvent(QMouseEvent * __arg0)
    {
        ...
        QMenu::mouseReleaseEvent(__arg0);
    }
    ...
    static void cpgf__register(const cpgf::GMetaDataConfigFlags & config, D _d)
    {
        ...
        _d.CPGF_MD_TEMPLATE _method("columnCount", (int (D::ClassType::*) () const)&D::ClassType::columnCount);
...
template <typename D>
void buildMetaClass_QMenuWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    
    QMenuWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QMenu<D>(config, _d);
}
