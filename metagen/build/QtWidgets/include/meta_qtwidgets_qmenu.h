...
#ifndef CPGF_META_QTWIDGETS_QMENU_H
#define CPGF_META_QTWIDGETS_QMENU_H
...
template <typename D>
void buildMetaClass_QMenu(D _d)
{
    (void)_d;
...
template <typename D>
void buildMetaClass_QMenuWrapper(D _d)
{
    (void)_d;
    using namespace cpgf;
    
    
    QMenuWrapper::cpgf__register(_d);
    
    buildMetaClass_QMenu<D>(_d);
}
