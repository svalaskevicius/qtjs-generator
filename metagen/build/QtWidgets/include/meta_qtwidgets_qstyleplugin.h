...
#ifndef __META_QTWIDGETS_QSTYLEPLUGIN_H
#define __META_QTWIDGETS_QSTYLEPLUGIN_H
...
public:
    ...
    QStyle * create(const QString & key)
    {
        ...
        if(func)
        {
            return cpgf::fromVariant<QStyle * >(cpgf::invokeScriptFunction(func.get(), this, key));
        }
