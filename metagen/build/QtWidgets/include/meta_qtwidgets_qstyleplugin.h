...
#ifndef CPGF_META_QTWIDGETS_QSTYLEPLUGIN_H
#define CPGF_META_QTWIDGETS_QSTYLEPLUGIN_H
...
class QStylePluginWrapper : public QStylePlugin, public cpgf::GScriptWrapper {
public:
    
    QStylePluginWrapper(QObject * parent = 0)
        : QStylePlugin(parent) {}
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QStylePlugin::qt_metacast(__arg0);
    }
    ...
    QStyle * create(const QString & key)
    {
        ...
        if(func)
        {
            return cpgf::fromVariant<QStyle * >(cpgf::invokeScriptFunctionOnObject(func.get(), this, key).getValue());
        }
        throw std::runtime_error("Abstract method");
    }
    QStyle * super_create(const QString & key)
    {
        throw std::runtime_error("Abstract method");
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QStylePlugin::qt_metacall(__arg0, __arg1, __arg2);
    }
    ...
    static void cpgf__register(D _d)
    {
        ...
        _d.CPGF_MD_TEMPLATE _method("super_create", (QStyle * (D::ClassType::*) (const QString &))&D::ClassType::super_create, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >());
