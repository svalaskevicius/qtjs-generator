...
#ifndef __META_QTWIDGETS_QTABLEVIEW_H
#define __META_QTWIDGETS_QTABLEVIEW_H
...
template <typename D>
void buildMetaClass_QTableView(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("horizontalHeader", &D::ClassType::horizontalHeader);
    _d.CPGF_MD_TEMPLATE _method("verticalHeader", &D::ClassType::verticalHeader);
    _d.CPGF_MD_TEMPLATE _method("setHorizontalHeader", &D::ClassType::setHorizontalHeader);
    _d.CPGF_MD_TEMPLATE _method("setVerticalHeader", &D::ClassType::setVerticalHeader);
    _d.CPGF_MD_TEMPLATE _method("rowViewportPosition", &D::ClassType::rowViewportPosition);
    _d.CPGF_MD_TEMPLATE _method("rowAt", &D::ClassType::rowAt);
    _d.CPGF_MD_TEMPLATE _method("setRowHeight", &D::ClassType::setRowHeight);
    _d.CPGF_MD_TEMPLATE _method("rowHeight", &D::ClassType::rowHeight);
    ...
    _d.CPGF_MD_TEMPLATE _method("showGrid", &D::ClassType::showGrid);
    _d.CPGF_MD_TEMPLATE _method("gridStyle", &D::ClassType::gridStyle);
    _d.CPGF_MD_TEMPLATE _method("setGridStyle", &D::ClassType::setGridStyle);
    _d.CPGF_MD_TEMPLATE _method("setWordWrap", &D::ClassType::setWordWrap);
    _d.CPGF_MD_TEMPLATE _method("wordWrap", &D::ClassType::wordWrap);
    _d.CPGF_MD_TEMPLATE _method("setCornerButtonEnabled", &D::ClassType::setCornerButtonEnabled);
    _d.CPGF_MD_TEMPLATE _method("isCornerButtonEnabled", &D::ClassType::isCornerButtonEnabled);
    ...
    _d.CPGF_MD_TEMPLATE _method("setSpan", &D::ClassType::setSpan);
    _d.CPGF_MD_TEMPLATE _method("rowSpan", &D::ClassType::rowSpan);
    _d.CPGF_MD_TEMPLATE _method("columnSpan", &D::ClassType::columnSpan);
    _d.CPGF_MD_TEMPLATE _method("clearSpans", &D::ClassType::clearSpans);
    ...
    _d.CPGF_MD_TEMPLATE _method("hideRow", &D::ClassType::hideRow);
    _d.CPGF_MD_TEMPLATE _method("hideColumn", &D::ClassType::hideColumn);
    _d.CPGF_MD_TEMPLATE _method("showRow", &D::ClassType::showRow);
    _d.CPGF_MD_TEMPLATE _method("showColumn", &D::ClassType::showColumn);
    _d.CPGF_MD_TEMPLATE _method("resizeRowToContents", &D::ClassType::resizeRowToContents);
    _d.CPGF_MD_TEMPLATE _method("resizeRowsToContents", &D::ClassType::resizeRowsToContents);
    _d.CPGF_MD_TEMPLATE _method("resizeColumnToContents", &D::ClassType::resizeColumnToContents);
    _d.CPGF_MD_TEMPLATE _method("resizeColumnsToContents", &D::ClassType::resizeColumnsToContents);
    _d.CPGF_MD_TEMPLATE _method("setShowGrid", &D::ClassType::setShowGrid);
...
class QTableViewWrapper : public QTableView, public cpgf::GScriptWrapper {
public:
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QTableView::qt_metacast(__arg0);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QTableView::qt_metacall(__arg0, __arg1, __arg2);
    }
...
template <typename D>
void buildMetaClass_QTableViewWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    
    QTableViewWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QTableView<D>(config, _d);
}
