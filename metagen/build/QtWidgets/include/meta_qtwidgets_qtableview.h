...
#ifndef CPGF_META_QTWIDGETS_QTABLEVIEW_H
#define CPGF_META_QTWIDGETS_QTABLEVIEW_H
...
template <typename D>
void buildMetaClass_QTableView(D _d)
{
    (void)_d;
...
template <typename D>
void buildMetaClass_QTableViewWrapper(D _d)
{
    (void)_d;
    using namespace cpgf;
    
    
    QTableViewWrapper::cpgf__register(_d);
    
    buildMetaClass_QTableView<D>(_d);
}
