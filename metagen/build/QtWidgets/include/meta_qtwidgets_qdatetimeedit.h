...
#ifndef CPGF_META_QTWIDGETS_QDATETIMEEDIT_H
#define CPGF_META_QTWIDGETS_QDATETIMEEDIT_H
...
void buildMetaClass_QDateEdit(D _d)
{
    ...
    ;
    _d.CPGF_MD_TEMPLATE _constructor<void * (const QDate &, QWidget *)>()
        ._default(copyVariantFromCopyable(0))
    ;
    ...
    _d.CPGF_MD_TEMPLATE _method("userDateChanged", &D::ClassType::userDateChanged);
...
class QDateEditWrapper : public QDateEdit, public cpgf::GScriptWrapper {
public:
    ...
    void stepBy(int steps)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunction(func.get(), this, steps);
            return;
        }
    ...
    {
        cpgf::GScopedInterface<cpgf::IScriptFunction> func(this->getScriptFunction("fixup"));
        if(func)
        {
            cpgf::invokeScriptFunction(func.get(), this, input);
            return;
        }
        QDateTimeEdit::fixup(input);
    }
    void super_fixup(QString & input) const
    {
        QDateTimeEdit::fixup(input);
    }
...
void buildMetaClass_QDateTimeEdit(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _constructor<void * (QWidget *)>()
        ._default(copyVariantFromCopyable(0))
    ;
    _d.CPGF_MD_TEMPLATE _constructor<void * (const QDateTime &, QWidget *)>(cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >())
        ._default(copyVariantFromCopyable(0))
    ;
    _d.CPGF_MD_TEMPLATE _constructor<void * (const QDate &, QWidget *)>()
        ._default(copyVariantFromCopyable(0))
    ;
    _d.CPGF_MD_TEMPLATE _constructor<void * (const QTime &, QWidget *)>()
        ._default(copyVariantFromCopyable(0))
    ;
    _d.CPGF_MD_TEMPLATE _field("staticMetaObject", &D::ClassType::staticMetaObject);
    _d.CPGF_MD_TEMPLATE _method("metaObject", &D::ClassType::metaObject);
    _d.CPGF_MD_TEMPLATE _method("qt_metacast", &D::ClassType::qt_metacast);
    _d.CPGF_MD_TEMPLATE _method("qt_metacall", &D::ClassType::qt_metacall);
    _d.CPGF_MD_TEMPLATE _method("dateTime", &D::ClassType::dateTime);
    _d.CPGF_MD_TEMPLATE _method("date", &D::ClassType::date);
    _d.CPGF_MD_TEMPLATE _method("time", &D::ClassType::time);
    _d.CPGF_MD_TEMPLATE _method("minimumDateTime", &D::ClassType::minimumDateTime);
    _d.CPGF_MD_TEMPLATE _method("clearMinimumDateTime", &D::ClassType::clearMinimumDateTime);
    _d.CPGF_MD_TEMPLATE _method("setMinimumDateTime", &D::ClassType::setMinimumDateTime, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >());
    _d.CPGF_MD_TEMPLATE _method("maximumDateTime", &D::ClassType::maximumDateTime);
    _d.CPGF_MD_TEMPLATE _method("clearMaximumDateTime", &D::ClassType::clearMaximumDateTime);
    _d.CPGF_MD_TEMPLATE _method("setMaximumDateTime", &D::ClassType::setMaximumDateTime, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >());
    _d.CPGF_MD_TEMPLATE _method("setDateTimeRange", &D::ClassType::setDateTimeRange, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0>, cpgf::GMetaRuleCopyConstReference<1> >());
    ...
    _d.CPGF_MD_TEMPLATE _method("clearMinimumDate", &D::ClassType::clearMinimumDate);
    ...
    _d.CPGF_MD_TEMPLATE _method("clearMaximumDate", &D::ClassType::clearMaximumDate);
    _d.CPGF_MD_TEMPLATE _method("setDateRange", &D::ClassType::setDateRange);
    _d.CPGF_MD_TEMPLATE _method("minimumTime", &D::ClassType::minimumTime);
    _d.CPGF_MD_TEMPLATE _method("setMinimumTime", &D::ClassType::setMinimumTime);
    _d.CPGF_MD_TEMPLATE _method("clearMinimumTime", &D::ClassType::clearMinimumTime);
    _d.CPGF_MD_TEMPLATE _method("maximumTime", &D::ClassType::maximumTime);
    _d.CPGF_MD_TEMPLATE _method("setMaximumTime", &D::ClassType::setMaximumTime);
    _d.CPGF_MD_TEMPLATE _method("clearMaximumTime", &D::ClassType::clearMaximumTime);
    _d.CPGF_MD_TEMPLATE _method("setTimeRange", &D::ClassType::setTimeRange);
    _d.CPGF_MD_TEMPLATE _method("displayedSections", &D::ClassType::displayedSections);
    _d.CPGF_MD_TEMPLATE _method("currentSection", &D::ClassType::currentSection);
    _d.CPGF_MD_TEMPLATE _method("sectionAt", &D::ClassType::sectionAt);
    _d.CPGF_MD_TEMPLATE _method("setCurrentSection", &D::ClassType::setCurrentSection);
    _d.CPGF_MD_TEMPLATE _method("currentSectionIndex", &D::ClassType::currentSectionIndex);
    _d.CPGF_MD_TEMPLATE _method("setCurrentSectionIndex", &D::ClassType::setCurrentSectionIndex);
    _d.CPGF_MD_TEMPLATE _method("calendarWidget", &D::ClassType::calendarWidget);
    _d.CPGF_MD_TEMPLATE _method("setCalendarWidget", &D::ClassType::setCalendarWidget);
    _d.CPGF_MD_TEMPLATE _method("sectionCount", &D::ClassType::sectionCount);
    _d.CPGF_MD_TEMPLATE _method("setSelectedSection", &D::ClassType::setSelectedSection);
    _d.CPGF_MD_TEMPLATE _method("sectionText", &D::ClassType::sectionText);
    _d.CPGF_MD_TEMPLATE _method("displayFormat", &D::ClassType::displayFormat);
    _d.CPGF_MD_TEMPLATE _method("setDisplayFormat", &D::ClassType::setDisplayFormat, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >());
    _d.CPGF_MD_TEMPLATE _method("calendarPopup", &D::ClassType::calendarPopup);
    _d.CPGF_MD_TEMPLATE _method("setCalendarPopup", &D::ClassType::setCalendarPopup);
    ...
    _d.CPGF_MD_TEMPLATE _method("stepBy", &D::ClassType::stepBy);
    _d.CPGF_MD_TEMPLATE _method("event", &D::ClassType::event);
    _d.CPGF_MD_TEMPLATE _method("dateTimeChanged", &D::ClassType::dateTimeChanged, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >());
    _d.CPGF_MD_TEMPLATE _method("timeChanged", &D::ClassType::timeChanged);
    _d.CPGF_MD_TEMPLATE _method("dateChanged", &D::ClassType::dateChanged);
    _d.CPGF_MD_TEMPLATE _method("setDateTime", &D::ClassType::setDateTime, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >());
    ...
    _d.CPGF_MD_TEMPLATE _method("tr", &D::ClassType::tr)
        ...
        ._default(copyVariantFromCopyable(0))
    ;
    _d.CPGF_MD_TEMPLATE _enum<typename D::ClassType::Section>("Section")
        ._element("NoSection", D::ClassType::NoSection)
        ._element("AmPmSection", D::ClassType::AmPmSection)
        ._element("MSecSection", D::ClassType::MSecSection)
        ._element("SecondSection", D::ClassType::SecondSection)
        ._element("MinuteSection", D::ClassType::MinuteSection)
        ._element("HourSection", D::ClassType::HourSection)
        ._element("DaySection", D::ClassType::DaySection)
        ._element("MonthSection", D::ClassType::MonthSection)
        ._element("YearSection", D::ClassType::YearSection)
...
class QDateTimeEditWrapper : public QDateTimeEdit, public cpgf::GScriptWrapper {
public:
...
void buildMetaClass_QTimeEdit(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("qt_metacast", &D::ClassType::qt_metacast);
    _d.CPGF_MD_TEMPLATE _method("qt_metacall", &D::ClassType::qt_metacall);
    _d.CPGF_MD_TEMPLATE _method("userTimeChanged", &D::ClassType::userTimeChanged);
    _d.CPGF_MD_TEMPLATE _method("tr", &D::ClassType::tr)
        ._default(copyVariantFromCopyable(-1))
        ._default(copyVariantFromCopyable(0))
    ;
...
class QTimeEditWrapper : public QTimeEdit, public cpgf::GScriptWrapper {
public:
