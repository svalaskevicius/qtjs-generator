...
#ifndef CPGF_META_QTWIDGETS_QCALENDARWIDGET_H
#define CPGF_META_QTWIDGETS_QCALENDARWIDGET_H
...
template <typename D>
void buildMetaClass_QCalendarWidget(D _d)
{
    (void)_d;
...
public:
    ...
    void paintCell(QPainter * painter, const QRect & rect, const QDate & date) const
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunctionOnObject(func.get(), this, painter, rect, date);
            return;
        }
...
template <typename D>
void buildMetaClass_QCalendarWidgetWrapper(D _d)
{
    (void)_d;
    using namespace cpgf;
    
    
    QCalendarWidgetWrapper::cpgf__register(_d);
    
    buildMetaClass_QCalendarWidget<D>(_d);
}
