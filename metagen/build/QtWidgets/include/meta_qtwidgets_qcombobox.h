...
#ifndef __META_QTWIDGETS_QCOMBOBOX_H
#define __META_QTWIDGETS_QCOMBOBOX_H
...
template <typename D>
void buildMetaClass_QComboBox(const cpgf::GMetaDataConfigFlags & config, D _d)
{
...
template <typename D>
void buildMetaClass_QComboBoxWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    
    QComboBoxWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QComboBox<D>(config, _d);
}
