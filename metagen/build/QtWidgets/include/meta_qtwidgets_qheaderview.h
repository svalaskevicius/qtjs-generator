...
public:
    ...
    QModelIndex moveCursor(QAbstractItemView::CursorAction __arg0, Qt::KeyboardModifiers __arg1)
    {
        ...
        if(func)
        {
            return cpgf::fromVariant<QModelIndex >(cpgf::invokeScriptFunction(func.get(), this, __arg0, __arg1).getValue());
        }
    ...
    QSize sectionSizeFromContents(int logicalIndex) const
    {
        ...
        if(func)
        {
            return cpgf::fromVariant<QSize >(cpgf::invokeScriptFunction(func.get(), this, logicalIndex).getValue());
        }
