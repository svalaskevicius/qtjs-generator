...
#ifndef __META_QTWIDGETS_QHEADERVIEW_H
#define __META_QTWIDGETS_QHEADERVIEW_H
...
template <typename D>
void buildMetaClass_QHeaderView(const cpgf::GMetaDataConfigFlags & config, D _d)
{
...
public:
    ...
    void currentChanged(const QModelIndex & current, const QModelIndex & old)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunction(func.get(), this, current, old);
            return;
        }
    ...
    QModelIndex moveCursor(QAbstractItemView::CursorAction __arg0, Qt::KeyboardModifiers __arg1)
    {
        ...
        if(func)
        {
            return cpgf::fromVariant<QModelIndex >(cpgf::invokeScriptFunction(func.get(), this, __arg0, __arg1));
        }
    ...
    void paintSection(QPainter * painter, const QRect & rect, int logicalIndex) const
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunction(func.get(), this, painter, rect, logicalIndex);
            return;
        }
    ...
    void setVisible(bool v)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunction(func.get(), this, v);
            return;
        }
    ...
    void setSelection(const QRect & rect, QItemSelectionModel::SelectionFlags flags)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunction(func.get(), this, rect, flags);
            return;
        }
    ...
    QSize sectionSizeFromContents(int logicalIndex) const
    {
        ...
        if(func)
        {
            return cpgf::fromVariant<QSize >(cpgf::invokeScriptFunction(func.get(), this, logicalIndex));
        }
...
template <typename D>
void buildMetaClass_QHeaderViewWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    
    QHeaderViewWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QHeaderView<D>(config, _d);
}
