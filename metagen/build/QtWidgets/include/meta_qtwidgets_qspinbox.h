...
public:
    ...
    QString textFromValue(double val) const
    {
        ...
        if(func)
        {
            return cpgf::fromVariant<QString >(cpgf::invokeScriptFunction(func.get(), this, val));
        }
    ...
    double valueFromText(const QString & text) const
    {
        ...
        if(func)
        {
            return cpgf::fromVariant<double >(cpgf::invokeScriptFunction(func.get(), this, text));
        }
...
public:
    ...
    int valueFromText(const QString & text) const
    {
        ...
        if(func)
        {
            return cpgf::fromVariant<int >(cpgf::invokeScriptFunction(func.get(), this, text));
        }
