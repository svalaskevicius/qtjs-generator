...
public:
    ...
    double valueFromText(const QString & text) const
    {
        ...
        if(func)
        {
            return cpgf::fromVariant<double >(cpgf::invokeScriptFunctionOnObject(func.get(), this, text).getValue());
        }
    ...
    QString textFromValue(double val) const
    {
        ...
        if(func)
        {
            return cpgf::fromVariant<QString >(cpgf::invokeScriptFunctionOnObject(func.get(), this, val).getValue());
        }
    ...
    void fixup(QString & str) const
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunctionOnObject(func.get(), this, str);
            return;
        }
...
public:
    ...
    int valueFromText(const QString & text) const
    {
        ...
        if(func)
        {
            return cpgf::fromVariant<int >(cpgf::invokeScriptFunctionOnObject(func.get(), this, text).getValue());
        }
