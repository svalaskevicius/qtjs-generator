...
#ifndef CPGF_META_QTWIDGETS_QSPINBOX_H
#define CPGF_META_QTWIDGETS_QSPINBOX_H
...
void buildMetaClass_QDoubleSpinBox(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("prefix", &D::ClassType::prefix);
    _d.CPGF_MD_TEMPLATE _method("setPrefix", &D::ClassType::setPrefix, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >());
    _d.CPGF_MD_TEMPLATE _method("suffix", &D::ClassType::suffix);
    _d.CPGF_MD_TEMPLATE _method("setSuffix", &D::ClassType::setSuffix, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >());
    _d.CPGF_MD_TEMPLATE _method("cleanText", &D::ClassType::cleanText);
    _d.CPGF_MD_TEMPLATE _method("singleStep", &D::ClassType::singleStep);
    _d.CPGF_MD_TEMPLATE _method("setSingleStep", &D::ClassType::setSingleStep);
    _d.CPGF_MD_TEMPLATE _method("minimum", &D::ClassType::minimum);
    _d.CPGF_MD_TEMPLATE _method("setMinimum", &D::ClassType::setMinimum);
    _d.CPGF_MD_TEMPLATE _method("maximum", &D::ClassType::maximum);
    _d.CPGF_MD_TEMPLATE _method("setMaximum", &D::ClassType::setMaximum);
    ...
    _d.CPGF_MD_TEMPLATE _method("valueFromText", &D::ClassType::valueFromText, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >());
    _d.CPGF_MD_TEMPLATE _method("textFromValue", &D::ClassType::textFromValue);
    _d.CPGF_MD_TEMPLATE _method("fixup", &D::ClassType::fixup);
    _d.CPGF_MD_TEMPLATE _method("setValue", &D::ClassType::setValue);
    _d.CPGF_MD_TEMPLATE _method("valueChanged", (void (D::ClassType::*) (double))&D::ClassType::valueChanged);
    _d.CPGF_MD_TEMPLATE _method("valueChanged", (void (D::ClassType::*) (const QString &))&D::ClassType::valueChanged, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >());
...
class QDoubleSpinBoxWrapper : public QDoubleSpinBox, public cpgf::GScriptWrapper {
public:
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QDoubleSpinBox::qt_metacast(__arg0);
    }
    ...
    {
        cpgf::GScopedInterface<cpgf::IScriptFunction> func(this->getScriptFunction("textFromValue"));
        if(func)
        {
            return cpgf::fromVariant<QString >(cpgf::invokeScriptFunction(func.get(), this, val).getValue());
        }
        return QDoubleSpinBox::textFromValue(val);
    }
    QString super_textFromValue(double val) const
    {
        return QDoubleSpinBox::textFromValue(val);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QDoubleSpinBox::qt_metacall(__arg0, __arg1, __arg2);
    }
    ...
    {
        cpgf::GScopedInterface<cpgf::IScriptFunction> func(this->getScriptFunction("valueFromText"));
        if(func)
        {
            return cpgf::fromVariant<double >(cpgf::invokeScriptFunction(func.get(), this, text).getValue());
        }
        return QDoubleSpinBox::valueFromText(text);
    }
    double super_valueFromText(const QString & text) const
    {
        return QDoubleSpinBox::valueFromText(text);
    }
    ...
    void fixup(QString & str) const
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunction(func.get(), this, str);
            return;
        }
        QDoubleSpinBox::fixup(str);
    }
    void super_fixup(QString & str) const
    {
        QDoubleSpinBox::fixup(str);
    }
    ...
    static void cpgf__register(D _d)
    {
        ...
        _d.CPGF_MD_TEMPLATE _method("super_textFromValue", (QString (D::ClassType::*) (double) const)&D::ClassType::super_textFromValue);
        ...
        _d.CPGF_MD_TEMPLATE _method("super_valueFromText", (double (D::ClassType::*) (const QString &) const)&D::ClassType::super_valueFromText, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >());
...
void buildMetaClass_QSpinBox(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("setMaximum", &D::ClassType::setMaximum);
    _d.CPGF_MD_TEMPLATE _method("setRange", &D::ClassType::setRange);
    _d.CPGF_MD_TEMPLATE _method("displayIntegerBase", &D::ClassType::displayIntegerBase);
    _d.CPGF_MD_TEMPLATE _method("setDisplayIntegerBase", &D::ClassType::setDisplayIntegerBase);
    _d.CPGF_MD_TEMPLATE _method("setValue", &D::ClassType::setValue);
    _d.CPGF_MD_TEMPLATE _method("valueChanged", (void (D::ClassType::*) (int))&D::ClassType::valueChanged);
    _d.CPGF_MD_TEMPLATE _method("valueChanged", (void (D::ClassType::*) (const QString &))&D::ClassType::valueChanged, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >());
    _d.CPGF_MD_TEMPLATE _method("tr", &D::ClassType::tr)
        ._default(copyVariantFromCopyable(-1))
        ._default(copyVariantFromCopyable(0))
...
class QSpinBoxWrapper : public QSpinBox, public cpgf::GScriptWrapper {
public:
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QSpinBox::qt_metacast(__arg0);
    }
    void * super_qt_metacast(const char * __arg0)
    {
        return QSpinBox::qt_metacast(__arg0);
    ...
    int valueFromText(const QString & text) const
    {
        ...
        if(func)
        {
            return cpgf::fromVariant<int >(cpgf::invokeScriptFunction(func.get(), this, text).getValue());
        }
        return QSpinBox::valueFromText(text);
    }
    int super_valueFromText(const QString & text) const
    {
        return QSpinBox::valueFromText(text);
    }
    ...
    QString super_textFromValue(int val) const
    {
        return QSpinBox::textFromValue(val);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QSpinBox::qt_metacall(__arg0, __arg1, __arg2);
    }
    int super_qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        return QSpinBox::qt_metacall(__arg0, __arg1, __arg2);
    ...
    static void cpgf__register(D _d)
    {
        ...
        _d.CPGF_MD_TEMPLATE _method("timerEvent", (void (D::ClassType::*) (QTimerEvent *))&D::ClassType::timerEvent);
        _d.CPGF_MD_TEMPLATE _method("paintEvent", (void (D::ClassType::*) (QPaintEvent *))&D::ClassType::paintEvent);
        _d.CPGF_MD_TEMPLATE _method("valueFromText", (int (D::ClassType::*) (const QString &) const)&D::ClassType::valueFromText, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >());
        _d.CPGF_MD_TEMPLATE _method("sender", (QObject * (D::ClassType::*) () const)&D::ClassType::sender);
        _d.CPGF_MD_TEMPLATE _method("destroy", (void (D::ClassType::*) (bool, bool))&D::ClassType::destroy)
            ._default(copyVariantFromCopyable(true))
            ._default(copyVariantFromCopyable(true))
        ...
        _d.CPGF_MD_TEMPLATE _method("changeEvent", (void (D::ClassType::*) (QEvent *))&D::ClassType::changeEvent);
        _d.CPGF_MD_TEMPLATE _method("sharedPainter", (QPainter * (D::ClassType::*) () const)&D::ClassType::sharedPainter);
        _d.CPGF_MD_TEMPLATE _method("textFromValue", (QString (D::ClassType::*) (int) const)&D::ClassType::textFromValue);
        _d.CPGF_MD_TEMPLATE _method("stepEnabled", (QAbstractSpinBox::StepEnabled (D::ClassType::*) () const)&D::ClassType::stepEnabled);
        _d.CPGF_MD_TEMPLATE _method("redirected", (QPaintDevice * (D::ClassType::*) (QPoint *) const)&D::ClassType::redirected);
        _d.CPGF_MD_TEMPLATE _method("disconnectNotify", (void (D::ClassType::*) (const QMetaMethod &))&D::ClassType::disconnectNotify);
        _d.CPGF_MD_TEMPLATE _method("enterEvent", (void (D::ClassType::*) (QEvent *))&D::ClassType::enterEvent);
        ...
        _d.CPGF_MD_TEMPLATE _method("super_timerEvent", (void (D::ClassType::*) (QTimerEvent *))&D::ClassType::super_timerEvent);
        _d.CPGF_MD_TEMPLATE _method("super_paintEvent", (void (D::ClassType::*) (QPaintEvent *))&D::ClassType::super_paintEvent);
        _d.CPGF_MD_TEMPLATE _method("super_valueFromText", (int (D::ClassType::*) (const QString &) const)&D::ClassType::super_valueFromText, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >());
        _d.CPGF_MD_TEMPLATE _method("super_mouseDoubleClickEvent", (void (D::ClassType::*) (QMouseEvent *))&D::ClassType::super_mouseDoubleClickEvent);
        _d.CPGF_MD_TEMPLATE _method("super_focusOutEvent", (void (D::ClassType::*) (QFocusEvent *))&D::ClassType::super_focusOutEvent);
        _d.CPGF_MD_TEMPLATE _method("super_moveEvent", (void (D::ClassType::*) (QMoveEvent *))&D::ClassType::super_moveEvent);
        _d.CPGF_MD_TEMPLATE _method("super_changeEvent", (void (D::ClassType::*) (QEvent *))&D::ClassType::super_changeEvent);
        ...
        _d.CPGF_MD_TEMPLATE _method("super_stepBy", (void (D::ClassType::*) (int))&D::ClassType::super_stepBy);
        _d.CPGF_MD_TEMPLATE _method("super_sharedPainter", (QPainter * (D::ClassType::*) () const)&D::ClassType::super_sharedPainter);
        _d.CPGF_MD_TEMPLATE _method("super_textFromValue", (QString (D::ClassType::*) (int) const)&D::ClassType::super_textFromValue);
        _d.CPGF_MD_TEMPLATE _method("super_stepEnabled", (QAbstractSpinBox::StepEnabled (D::ClassType::*) () const)&D::ClassType::super_stepEnabled);
        _d.CPGF_MD_TEMPLATE _method("super_eventFilter", (bool (D::ClassType::*) (QObject *, QEvent *))&D::ClassType::super_eventFilter);
        _d.CPGF_MD_TEMPLATE _method("super_redirected", (QPaintDevice * (D::ClassType::*) (QPoint *) const)&D::ClassType::super_redirected);
        _d.CPGF_MD_TEMPLATE _method("super_qt_metacall", (int (D::ClassType::*) (QMetaObject::Call, int, void **))&D::ClassType::super_qt_metacall);
