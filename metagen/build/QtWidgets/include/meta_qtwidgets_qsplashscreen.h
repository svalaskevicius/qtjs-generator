...
#ifndef __META_QTWIDGETS_QSPLASHSCREEN_H
#define __META_QTWIDGETS_QSPLASHSCREEN_H
...
template <typename D>
void buildMetaClass_QSplashScreen(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    _d.CPGF_MD_TEMPLATE _constructor<void * (const QPixmap &, Qt::WindowFlags)>()
        ._default(copyVariantFromCopyable(0))
        ._default(copyVariantFromCopyable(QPixmap()))
    ;
    _d.CPGF_MD_TEMPLATE _constructor<void * (QWidget *, const QPixmap &, Qt::WindowFlags)>()
        ._default(copyVariantFromCopyable(0))
        ._default(copyVariantFromCopyable(QPixmap()))
    ;
    ...
    _d.CPGF_MD_TEMPLATE _method("repaint", &D::ClassType::repaint);
    _d.CPGF_MD_TEMPLATE _method("message", &D::ClassType::message);
    _d.CPGF_MD_TEMPLATE _method("showMessage", &D::ClassType::showMessage, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0>, cpgf::GMetaRuleCopyConstReference<2> >())
        ._default(copyVariantFromCopyable(Qt::black))
        ._default(copyVariantFromCopyable(Qt::AlignLeft))
    ;
    _d.CPGF_MD_TEMPLATE _method("clearMessage", &D::ClassType::clearMessage);
    _d.CPGF_MD_TEMPLATE _method("messageChanged", &D::ClassType::messageChanged, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >());
...
class QSplashScreenWrapper : public QSplashScreen, public cpgf::GScriptWrapper {
public:
    
    QSplashScreenWrapper(const QPixmap & pixmap = QPixmap(), Qt::WindowFlags f = 0)
        : QSplashScreen(pixmap, f) {}
    
    QSplashScreenWrapper(QWidget * parent, const QPixmap & pixmap = QPixmap(), Qt::WindowFlags f = 0)
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QSplashScreen::qt_metacast(__arg0);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QSplashScreen::qt_metacall(__arg0, __arg1, __arg2);
    }
    ...
    {
        cpgf::GScopedInterface<cpgf::IScriptFunction> func(this->getScriptFunction("drawContents"));
        if(func)
        {
            cpgf::invokeScriptFunction(func.get(), this, painter);
            return;
    ...
    void super_drawContents(QPainter * painter)
    {
        QSplashScreen::drawContents(painter);
    }
    ...
    void mousePressEvent(QMouseEvent * __arg0)
    {
        ...
        QSplashScreen::mousePressEvent(__arg0);
    }
    ...
    static void cpgf__register(const cpgf::GMetaDataConfigFlags & config, D _d)
    {
        ...
        _d.CPGF_MD_TEMPLATE _method("drawContents", (void (D::ClassType::*) (QPainter *))&D::ClassType::drawContents);
        ...
        _d.CPGF_MD_TEMPLATE _method("super_drawContents", (void (D::ClassType::*) (QPainter *))&D::ClassType::super_drawContents);
...
template <typename D>
void buildMetaClass_QSplashScreenWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    
    QSplashScreenWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QSplashScreen<D>(config, _d);
}
