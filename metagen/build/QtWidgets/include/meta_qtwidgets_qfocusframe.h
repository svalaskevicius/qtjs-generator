...
#ifndef __META_QTWIDGETS_QFOCUSFRAME_H
#define __META_QTWIDGETS_QFOCUSFRAME_H
...
template <typename D>
void buildMetaClass_QFocusFrame(const cpgf::GMetaDataConfigFlags & config, D _d)
{
...
class QFocusFrameWrapper : public QFocusFrame, public cpgf::GScriptWrapper {
public:
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QFocusFrame::qt_metacast(__arg0);
    }
    ...
    bool eventFilter(QObject * __arg0, QEvent * __arg1)
    {
        ...
        return QFocusFrame::eventFilter(__arg0, __arg1);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QFocusFrame::qt_metacall(__arg0, __arg1, __arg2);
    }
...
template <typename D>
void buildMetaClass_QFocusFrameWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    
    QFocusFrameWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QFocusFrame<D>(config, _d);
}
