...
#ifndef __META_QTWIDGETS_QSTACKEDWIDGET_H
#define __META_QTWIDGETS_QSTACKEDWIDGET_H
...
template <typename D>
void buildMetaClass_QStackedWidget(const cpgf::GMetaDataConfigFlags & config, D _d)
{
...
class QStackedWidgetWrapper : public QStackedWidget, public cpgf::GScriptWrapper {
public:
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QStackedWidget::qt_metacast(__arg0);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QStackedWidget::qt_metacall(__arg0, __arg1, __arg2);
    }
...
template <typename D>
void buildMetaClass_QStackedWidgetWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    
    QStackedWidgetWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QStackedWidget<D>(config, _d);
}
