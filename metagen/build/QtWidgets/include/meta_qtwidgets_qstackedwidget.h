...
#ifndef CPGF_META_QTWIDGETS_QSTACKEDWIDGET_H
#define CPGF_META_QTWIDGETS_QSTACKEDWIDGET_H
...
template <typename D>
void buildMetaClass_QStackedWidget(D _d)
{
    (void)_d;
...
template <typename D>
void buildMetaClass_QStackedWidgetWrapper(D _d)
{
    (void)_d;
    using namespace cpgf;
    
    
    QStackedWidgetWrapper::cpgf__register(_d);
    
    buildMetaClass_QStackedWidget<D>(_d);
}
