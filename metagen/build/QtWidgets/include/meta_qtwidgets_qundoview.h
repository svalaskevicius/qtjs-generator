...
#ifndef __META_QTWIDGETS_QUNDOVIEW_H
#define __META_QTWIDGETS_QUNDOVIEW_H
...
template <typename D>
void buildMetaClass_QUndoView(const cpgf::GMetaDataConfigFlags & config, D _d)
{
...
template <typename D>
void buildMetaClass_QUndoViewWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    
    QUndoViewWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QUndoView<D>(config, _d);
}
