...
#ifndef __META_QTWIDGETS_QTOOLBOX_H
...
template <typename D>
void buildMetaClass_QToolBox(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("addItem", (int (D::ClassType::*) (QWidget *, const QString &))&D::ClassType::addItem, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<1> >());
    _d.CPGF_MD_TEMPLATE _method("addItem", (int (D::ClassType::*) (QWidget *, const QIcon &, const QString &))&D::ClassType::addItem, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<1>, cpgf::GMetaRuleCopyConstReference<2> >());
    _d.CPGF_MD_TEMPLATE _method("insertItem", (int (D::ClassType::*) (int, QWidget *, const QString &))&D::ClassType::insertItem, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<2> >());
    _d.CPGF_MD_TEMPLATE _method("insertItem", (int (D::ClassType::*) (int, QWidget *, const QIcon &, const QString &))&D::ClassType::insertItem, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<2>, cpgf::GMetaRuleCopyConstReference<3> >());
    ...
    _d.CPGF_MD_TEMPLATE _method("setItemToolTip", &D::ClassType::setItemToolTip, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<1> >());
    _d.CPGF_MD_TEMPLATE _method("itemToolTip", &D::ClassType::itemToolTip);
...
class QToolBoxWrapper : public QToolBox, public cpgf::GScriptWrapper {
public:
    
    QToolBoxWrapper(QWidget * parent = 0, Qt::WindowFlags f = 0)
        : QToolBox(parent, f) {}
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QToolBox::qt_metacast(__arg0);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QToolBox::qt_metacall(__arg0, __arg1, __arg2);
    }
    ...
    {
        cpgf::GScopedInterface<cpgf::IScriptFunction> func(this->getScriptFunction("itemInserted"));
        if(func)
        {
    ...
    void super_itemInserted(int index)
    {
        QToolBox::itemInserted(index);
    }
    ...
    {
        cpgf::GScopedInterface<cpgf::IScriptFunction> func(this->getScriptFunction("itemRemoved"));
        if(func)
        {
            cpgf::invokeScriptFunction(func.get(), this, index);
            return;
    ...
    void super_itemRemoved(int index)
    {
        QToolBox::itemRemoved(index);
    }
    ...
    static void cpgf__register(const cpgf::GMetaDataConfigFlags & config, D _d)
    {
        ...
        _d.CPGF_MD_TEMPLATE _method("itemInserted", (void (D::ClassType::*) (int))&D::ClassType::itemInserted);
        ...
        _d.CPGF_MD_TEMPLATE _method("itemRemoved", (void (D::ClassType::*) (int))&D::ClassType::itemRemoved);
        ...
        _d.CPGF_MD_TEMPLATE _method("super_itemInserted", (void (D::ClassType::*) (int))&D::ClassType::super_itemInserted);
        ...
        _d.CPGF_MD_TEMPLATE _method("super_itemRemoved", (void (D::ClassType::*) (int))&D::ClassType::super_itemRemoved);
...
template <typename D>
void buildMetaClass_QToolBoxWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    
    QToolBoxWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QToolBox<D>(config, _d);
}
