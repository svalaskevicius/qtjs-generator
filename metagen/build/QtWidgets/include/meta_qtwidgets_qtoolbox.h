...
#ifndef CPGF_META_QTWIDGETS_QTOOLBOX_H
#define CPGF_META_QTWIDGETS_QTOOLBOX_H
...
template <typename D>
void buildMetaClass_QToolBox(D _d)
{
    (void)_d;
...
template <typename D>
void buildMetaClass_QToolBoxWrapper(D _d)
{
    (void)_d;
    using namespace cpgf;
    
    
    QToolBoxWrapper::cpgf__register(_d);
    
    buildMetaClass_QToolBox<D>(_d);
}
