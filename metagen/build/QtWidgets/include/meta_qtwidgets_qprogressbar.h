...
#ifndef CPGF_META_QTWIDGETS_QPROGRESSBAR_H
#define CPGF_META_QTWIDGETS_QPROGRESSBAR_H
...
template <typename D>
void buildMetaClass_QProgressBar(D _d)
{
    (void)_d;
...
template <typename D>
void buildMetaClass_QProgressBarWrapper(D _d)
{
    (void)_d;
    using namespace cpgf;
    
    
    QProgressBarWrapper::cpgf__register(_d);
    
    buildMetaClass_QProgressBar<D>(_d);
}
