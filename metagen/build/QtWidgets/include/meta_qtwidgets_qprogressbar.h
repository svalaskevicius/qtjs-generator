...
#ifndef __META_QTWIDGETS_QPROGRESSBAR_H
#define __META_QTWIDGETS_QPROGRESSBAR_H
...
template <typename D>
void buildMetaClass_QProgressBar(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("setTextVisible", &D::ClassType::setTextVisible);
    _d.CPGF_MD_TEMPLATE _method("isTextVisible", &D::ClassType::isTextVisible);
...
class QProgressBarWrapper : public QProgressBar, public cpgf::GScriptWrapper {
public:
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QProgressBar::qt_metacast(__arg0);
    }
    ...
    void paintEvent(QPaintEvent * __arg0)
    {
        ...
        QProgressBar::paintEvent(__arg0);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QProgressBar::qt_metacall(__arg0, __arg1, __arg2);
    }
    ...
    static void cpgf__register(const cpgf::GMetaDataConfigFlags & config, D _d)
    {
        ...
        _d.CPGF_MD_TEMPLATE _method("initStyleOption", (void (D::ClassType::*) (QStyleOptionProgressBar *) const)&D::ClassType::initStyleOption);
        ...
        _d.CPGF_MD_TEMPLATE _method("super_text", (QString (D::ClassType::*) () const)&D::ClassType::super_text);
...
template <typename D>
void buildMetaClass_QProgressBarWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    
    QProgressBarWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QProgressBar<D>(config, _d);
}
