...
#ifndef CPGF_META_QTWIDGETS_QSHORTCUT_H
#define CPGF_META_QTWIDGETS_QSHORTCUT_H
...
void buildMetaClass_QShortcut(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _constructor<void * (const QKeySequence &, QWidget *, const char *, const char *, Qt::ShortcutContext)>(cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >())
    ...
    _d.CPGF_MD_TEMPLATE _method("setContext", &D::ClassType::setContext);
    ...
    _d.CPGF_MD_TEMPLATE _method("activatedAmbiguously", &D::ClassType::activatedAmbiguously);
...
class QShortcutWrapper : public QShortcut, public cpgf::GScriptWrapper {
public:
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QShortcut::qt_metacast(__arg0);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QShortcut::qt_metacall(__arg0, __arg1, __arg2);
    }
