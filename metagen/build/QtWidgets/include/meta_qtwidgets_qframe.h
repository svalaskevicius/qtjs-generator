...
#ifndef __META_QTWIDGETS_QFRAME_H
#define __META_QTWIDGETS_QFRAME_H
...
template <typename D>
void buildMetaClass_QFrame(const cpgf::GMetaDataConfigFlags & config, D _d)
{
...
template <typename D>
void buildMetaClass_QFrameWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    
    QFrameWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QFrame<D>(config, _d);
}
