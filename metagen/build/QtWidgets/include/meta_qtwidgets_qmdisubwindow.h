...
public:
    ...
    void hideEvent(QHideEvent * hideEvent)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunction(func.get(), this, hideEvent);
            return;
        }
    ...
    void focusInEvent(QFocusEvent * focusInEvent)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunction(func.get(), this, focusInEvent);
            return;
        }
    ...
    void contextMenuEvent(QContextMenuEvent * contextMenuEvent)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunction(func.get(), this, contextMenuEvent);
            return;
        }
    ...
    void leaveEvent(QEvent * leaveEvent)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunction(func.get(), this, leaveEvent);
            return;
        }
    ...
    void mouseDoubleClickEvent(QMouseEvent * mouseEvent)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunction(func.get(), this, mouseEvent);
            return;
        }
    ...
    void focusOutEvent(QFocusEvent * focusOutEvent)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunction(func.get(), this, focusOutEvent);
            return;
        }
    ...
    void moveEvent(QMoveEvent * moveEvent)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunction(func.get(), this, moveEvent);
            return;
        }
    ...
    void changeEvent(QEvent * changeEvent)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunction(func.get(), this, changeEvent);
            return;
        }
    ...
    void keyPressEvent(QKeyEvent * keyEvent)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunction(func.get(), this, keyEvent);
            return;
        }
    ...
    void closeEvent(QCloseEvent * closeEvent)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunction(func.get(), this, closeEvent);
            return;
        }
