...
#ifndef CPGF_META_QTWIDGETS_QMDISUBWINDOW_H
#define CPGF_META_QTWIDGETS_QMDISUBWINDOW_H
...
void buildMetaClass_QMdiSubWindow(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("maximizedButtonsWidget", &D::ClassType::maximizedButtonsWidget);
    _d.CPGF_MD_TEMPLATE _method("maximizedSystemMenuIconWidget", &D::ClassType::maximizedSystemMenuIconWidget);
    _d.CPGF_MD_TEMPLATE _method("isShaded", &D::ClassType::isShaded);
    ...
    _d.CPGF_MD_TEMPLATE _method("setKeyboardSingleStep", &D::ClassType::setKeyboardSingleStep);
    _d.CPGF_MD_TEMPLATE _method("keyboardSingleStep", &D::ClassType::keyboardSingleStep);
    _d.CPGF_MD_TEMPLATE _method("setKeyboardPageStep", &D::ClassType::setKeyboardPageStep);
    _d.CPGF_MD_TEMPLATE _method("keyboardPageStep", &D::ClassType::keyboardPageStep);
    _d.CPGF_MD_TEMPLATE _method("setSystemMenu", &D::ClassType::setSystemMenu);
    _d.CPGF_MD_TEMPLATE _method("systemMenu", &D::ClassType::systemMenu);
    _d.CPGF_MD_TEMPLATE _method("mdiArea", &D::ClassType::mdiArea);
    _d.CPGF_MD_TEMPLATE _method("windowStateChanged", &D::ClassType::windowStateChanged);
    _d.CPGF_MD_TEMPLATE _method("aboutToActivate", &D::ClassType::aboutToActivate);
    _d.CPGF_MD_TEMPLATE _method("showSystemMenu", &D::ClassType::showSystemMenu);
    _d.CPGF_MD_TEMPLATE _method("showShaded", &D::ClassType::showShaded);
    _d.CPGF_MD_TEMPLATE _method("tr", &D::ClassType::tr)
        ._default(copyVariantFromCopyable(-1))
        ._default(copyVariantFromCopyable(0))
    ;
    _d.CPGF_MD_TEMPLATE _enum<typename D::ClassType::SubWindowOption>("SubWindowOption")
        ._element("AllowOutsideAreaHorizontally", D::ClassType::AllowOutsideAreaHorizontally)
        ._element("AllowOutsideAreaVertically", D::ClassType::AllowOutsideAreaVertically)
...
class QMdiSubWindowWrapper : public QMdiSubWindow, public cpgf::GScriptWrapper {
public:
    
    QMdiSubWindowWrapper(QWidget * parent = 0, Qt::WindowFlags flags = 0)
    ...
    void mouseDoubleClickEvent(QMouseEvent * mouseEvent)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunctionOnObject(func.get(), this, mouseEvent);
            return;
        }
        QMdiSubWindow::mouseDoubleClickEvent(mouseEvent);
    }
    void super_mouseDoubleClickEvent(QMouseEvent * mouseEvent)
    {
        QMdiSubWindow::mouseDoubleClickEvent(mouseEvent);
    }
    ...
    void resizeEvent(QResizeEvent * resizeEvent)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunctionOnObject(func.get(), this, resizeEvent);
            return;
        }
    ...
    void showEvent(QShowEvent * showEvent)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunctionOnObject(func.get(), this, showEvent);
            return;
        }
    ...
    void super_mouseReleaseEvent(QMouseEvent * mouseEvent)
    {
        QMdiSubWindow::mouseReleaseEvent(mouseEvent);
    }
    ...
    void focusOutEvent(QFocusEvent * focusOutEvent)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunctionOnObject(func.get(), this, focusOutEvent);
            return;
        }
        QMdiSubWindow::focusOutEvent(focusOutEvent);
    }
    void super_focusOutEvent(QFocusEvent * focusOutEvent)
    {
        QMdiSubWindow::focusOutEvent(focusOutEvent);
    }
    ...
    void hideEvent(QHideEvent * hideEvent)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunctionOnObject(func.get(), this, hideEvent);
            return;
        }
        QMdiSubWindow::hideEvent(hideEvent);
    }
    void super_hideEvent(QHideEvent * hideEvent)
    {
        QMdiSubWindow::hideEvent(hideEvent);
    }
    ...
    void childEvent(QChildEvent * childEvent)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunctionOnObject(func.get(), this, childEvent);
            return;
        }
    ...
    void contextMenuEvent(QContextMenuEvent * contextMenuEvent)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunctionOnObject(func.get(), this, contextMenuEvent);
            return;
        }
        QMdiSubWindow::contextMenuEvent(contextMenuEvent);
    }
    void super_contextMenuEvent(QContextMenuEvent * contextMenuEvent)
    {
        QMdiSubWindow::contextMenuEvent(contextMenuEvent);
    }
    ...
    void closeEvent(QCloseEvent * closeEvent)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunctionOnObject(func.get(), this, closeEvent);
            return;
        }
        QMdiSubWindow::closeEvent(closeEvent);
    }
    void super_closeEvent(QCloseEvent * closeEvent)
    {
        QMdiSubWindow::closeEvent(closeEvent);
    }
    ...
    void focusInEvent(QFocusEvent * focusInEvent)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunctionOnObject(func.get(), this, focusInEvent);
            return;
        }
        QMdiSubWindow::focusInEvent(focusInEvent);
    }
    void super_focusInEvent(QFocusEvent * focusInEvent)
    {
        QMdiSubWindow::focusInEvent(focusInEvent);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QMdiSubWindow::qt_metacall(__arg0, __arg1, __arg2);
    }
    ...
    void leaveEvent(QEvent * leaveEvent)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunctionOnObject(func.get(), this, leaveEvent);
            return;
        }
        QMdiSubWindow::leaveEvent(leaveEvent);
    }
    void super_leaveEvent(QEvent * leaveEvent)
    {
        QMdiSubWindow::leaveEvent(leaveEvent);
    }
    ...
    void moveEvent(QMoveEvent * moveEvent)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunctionOnObject(func.get(), this, moveEvent);
            return;
        }
        QMdiSubWindow::moveEvent(moveEvent);
    }
    void super_moveEvent(QMoveEvent * moveEvent)
    {
        QMdiSubWindow::moveEvent(moveEvent);
    }
    ...
    void timerEvent(QTimerEvent * timerEvent)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunctionOnObject(func.get(), this, timerEvent);
            return;
        }
    ...
    void changeEvent(QEvent * changeEvent)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunctionOnObject(func.get(), this, changeEvent);
            return;
        }
        QMdiSubWindow::changeEvent(changeEvent);
    }
    void super_changeEvent(QEvent * changeEvent)
    {
        QMdiSubWindow::changeEvent(changeEvent);
    }
    ...
    void keyPressEvent(QKeyEvent * keyEvent)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunctionOnObject(func.get(), this, keyEvent);
            return;
        }
        QMdiSubWindow::keyPressEvent(keyEvent);
    }
    void super_keyPressEvent(QKeyEvent * keyEvent)
    {
        QMdiSubWindow::keyPressEvent(keyEvent);
    }
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QMdiSubWindow::qt_metacast(__arg0);
    }
    ...
    void super_mouseMoveEvent(QMouseEvent * mouseEvent)
    {
        QMdiSubWindow::mouseMoveEvent(mouseEvent);
    }
    ...
    void paintEvent(QPaintEvent * paintEvent)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunctionOnObject(func.get(), this, paintEvent);
            return;
        }
    ...
    void super_mousePressEvent(QMouseEvent * mouseEvent)
    {
        QMdiSubWindow::mousePressEvent(mouseEvent);
    }
    template <typename D>
