...
#ifndef __META_QTWIDGETS_QABSTRACTSLIDER_H
#define __META_QTWIDGETS_QABSTRACTSLIDER_H
...
template <typename D>
void buildMetaClass_QAbstractSlider(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("setPageStep", &D::ClassType::setPageStep);
    _d.CPGF_MD_TEMPLATE _method("pageStep", &D::ClassType::pageStep);
    _d.CPGF_MD_TEMPLATE _method("setTracking", &D::ClassType::setTracking);
    _d.CPGF_MD_TEMPLATE _method("hasTracking", &D::ClassType::hasTracking);
    _d.CPGF_MD_TEMPLATE _method("setSliderDown", &D::ClassType::setSliderDown);
    _d.CPGF_MD_TEMPLATE _method("isSliderDown", &D::ClassType::isSliderDown);
    _d.CPGF_MD_TEMPLATE _method("setSliderPosition", &D::ClassType::setSliderPosition);
    _d.CPGF_MD_TEMPLATE _method("sliderPosition", &D::ClassType::sliderPosition);
    _d.CPGF_MD_TEMPLATE _method("setInvertedAppearance", &D::ClassType::setInvertedAppearance);
    _d.CPGF_MD_TEMPLATE _method("invertedAppearance", &D::ClassType::invertedAppearance);
    _d.CPGF_MD_TEMPLATE _method("setInvertedControls", &D::ClassType::setInvertedControls);
    _d.CPGF_MD_TEMPLATE _method("invertedControls", &D::ClassType::invertedControls);
    _d.CPGF_MD_TEMPLATE _method("value", &D::ClassType::value);
    _d.CPGF_MD_TEMPLATE _method("triggerAction", &D::ClassType::triggerAction);
    ...
    _d.CPGF_MD_TEMPLATE _method("sliderPressed", &D::ClassType::sliderPressed);
    _d.CPGF_MD_TEMPLATE _method("sliderMoved", &D::ClassType::sliderMoved);
    _d.CPGF_MD_TEMPLATE _method("sliderReleased", &D::ClassType::sliderReleased);
    _d.CPGF_MD_TEMPLATE _method("rangeChanged", &D::ClassType::rangeChanged);
    _d.CPGF_MD_TEMPLATE _method("actionTriggered", &D::ClassType::actionTriggered);
    _d.CPGF_MD_TEMPLATE _method("tr", &D::ClassType::tr)
        ._default(copyVariantFromCopyable(-1))
        ._default(copyVariantFromCopyable(0))
    ;
    _d.CPGF_MD_TEMPLATE _enum<typename D::ClassType::SliderAction>("SliderAction")
        ._element("SliderNoAction", D::ClassType::SliderNoAction)
        ._element("SliderSingleStepAdd", D::ClassType::SliderSingleStepAdd)
        ._element("SliderSingleStepSub", D::ClassType::SliderSingleStepSub)
        ._element("SliderPageStepAdd", D::ClassType::SliderPageStepAdd)
        ._element("SliderPageStepSub", D::ClassType::SliderPageStepSub)
        ._element("SliderToMinimum", D::ClassType::SliderToMinimum)
        ._element("SliderToMaximum", D::ClassType::SliderToMaximum)
        ._element("SliderMove", D::ClassType::SliderMove)
    ;
}


class QAbstractSliderWrapper : public QAbstractSlider, public cpgf::GScriptWrapper {
public:
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QAbstractSlider::qt_metacast(__arg0);
    }
    ...
    void timerEvent(QTimerEvent * __arg0)
    {
        ...
        QAbstractSlider::timerEvent(__arg0);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QAbstractSlider::qt_metacall(__arg0, __arg1, __arg2);
    }
    ...
    {
        cpgf::GScopedInterface<cpgf::IScriptFunction> func(this->getScriptFunction("sliderChange"));
        if(func)
        {
            cpgf::invokeScriptFunction(func.get(), this, change);
            return;
        }
        QAbstractSlider::sliderChange(change);
    }
    void super_sliderChange(QAbstractSlider::SliderChange change)
    {
        QAbstractSlider::sliderChange(change);
    }
    ...
    static void cpgf__register(const cpgf::GMetaDataConfigFlags & config, D _d)
    {
        ...
        _d.CPGF_MD_TEMPLATE _method("setRepeatAction", (void (D::ClassType::*) (QAbstractSlider::SliderAction, int, int))&D::ClassType::setRepeatAction)
        ...
        _d.CPGF_MD_TEMPLATE _method("sliderChange", (void (D::ClassType::*) (QAbstractSlider::SliderChange))&D::ClassType::sliderChange);
        ...
        _d.CPGF_MD_TEMPLATE _method("super_sliderChange", (void (D::ClassType::*) (QAbstractSlider::SliderChange))&D::ClassType::super_sliderChange);
...
template <typename D>
void buildMetaClass_QAbstractSliderWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    
    QAbstractSliderWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QAbstractSlider<D>(config, _d);
}
