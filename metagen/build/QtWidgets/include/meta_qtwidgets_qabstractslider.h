...
#ifndef CPGF_META_QTWIDGETS_QABSTRACTSLIDER_H
#define CPGF_META_QTWIDGETS_QABSTRACTSLIDER_H
...
template <typename D>
void buildMetaClass_QAbstractSlider(D _d)
{
    (void)_d;
...
public:
    ...
    void sliderChange(QAbstractSlider::SliderChange change)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunctionOnObject(func.get(), this, change);
            return;
        }
...
template <typename D>
void buildMetaClass_QAbstractSliderWrapper(D _d)
{
    (void)_d;
    using namespace cpgf;
    
    
    QAbstractSliderWrapper::cpgf__register(_d);
    
    buildMetaClass_QAbstractSlider<D>(_d);
}
