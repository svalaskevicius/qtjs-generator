...
#ifndef __META_QTWIDGETS_QDIALOGBUTTONBOX_H
...
template <typename D>
void buildMetaClass_QDialogButtonBox(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _constructor<void * (Qt::Orientation, QWidget *)>()
        ._default(copyVariantFromCopyable(0))
    ;
    _d.CPGF_MD_TEMPLATE _constructor<void * (QDialogButtonBox::StandardButtons, QWidget *)>()
        ._default(copyVariantFromCopyable(0))
    ;
    _d.CPGF_MD_TEMPLATE _constructor<void * (QDialogButtonBox::StandardButtons, Qt::Orientation, QWidget *)>()
        ._default(copyVariantFromCopyable(0))
    ;
    ...
    _d.CPGF_MD_TEMPLATE _method("addButton", (void (D::ClassType::*) (QAbstractButton *, QDialogButtonBox::ButtonRole))&D::ClassType::addButton);
    _d.CPGF_MD_TEMPLATE _method("addButton", (QPushButton * (D::ClassType::*) (const QString &, QDialogButtonBox::ButtonRole))&D::ClassType::addButton, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >());
    _d.CPGF_MD_TEMPLATE _method("addButton", (QPushButton * (D::ClassType::*) (QDialogButtonBox::StandardButton))&D::ClassType::addButton);
    ...
    _d.CPGF_MD_TEMPLATE _method("setCenterButtons", &D::ClassType::setCenterButtons);
    _d.CPGF_MD_TEMPLATE _method("centerButtons", &D::ClassType::centerButtons);
    ...
    _d.CPGF_MD_TEMPLATE _method("rejected", &D::ClassType::rejected);
    ...
    ;
    _d.CPGF_MD_TEMPLATE _enum<typename D::ClassType::ButtonLayout>("ButtonLayout")
        ._element("WinLayout", D::ClassType::WinLayout)
        ._element("MacLayout", D::ClassType::MacLayout)
...
class QDialogButtonBoxWrapper : public QDialogButtonBox, public cpgf::GScriptWrapper {
public:
    ...
    QDialogButtonBoxWrapper(QDialogButtonBox::StandardButtons buttons, QWidget * parent = 0)
        : QDialogButtonBox(buttons, parent) {}
    
    QDialogButtonBoxWrapper(QDialogButtonBox::StandardButtons buttons, Qt::Orientation orientation, QWidget * parent = 0)
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QDialogButtonBox::qt_metacast(__arg0);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QDialogButtonBox::qt_metacall(__arg0, __arg1, __arg2);
    }
...
template <typename D>
void buildMetaClass_QDialogButtonBoxWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    
    QDialogButtonBoxWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QDialogButtonBox<D>(config, _d);
}
