...
#ifndef CPGF_META_QTWIDGETS_QDIALOGBUTTONBOX_H
#define CPGF_META_QTWIDGETS_QDIALOGBUTTONBOX_H
...
template <typename D>
void buildMetaClass_QDialogButtonBox(D _d)
{
    (void)_d;
...
template <typename D>
void buildMetaClass_QDialogButtonBoxWrapper(D _d)
{
    (void)_d;
    using namespace cpgf;
    
    
    QDialogButtonBoxWrapper::cpgf__register(_d);
    
    buildMetaClass_QDialogButtonBox<D>(_d);
}
