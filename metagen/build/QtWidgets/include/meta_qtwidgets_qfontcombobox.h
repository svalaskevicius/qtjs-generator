...
#ifndef __META_QTWIDGETS_QFONTCOMBOBOX_H
...
template <typename D>
void buildMetaClass_QFontComboBox(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("setWritingSystem", &D::ClassType::setWritingSystem);
    _d.CPGF_MD_TEMPLATE _method("writingSystem", &D::ClassType::writingSystem);
    _d.CPGF_MD_TEMPLATE _method("setFontFilters", &D::ClassType::setFontFilters);
    _d.CPGF_MD_TEMPLATE _method("fontFilters", &D::ClassType::fontFilters);
    ...
    _d.CPGF_MD_TEMPLATE _method("tr", &D::ClassType::tr)
        ...
        ._default(copyVariantFromCopyable(0))
    ;
    _d.CPGF_MD_TEMPLATE _enum<typename D::ClassType::FontFilter>("FontFilter")
        ._element("AllFonts", D::ClassType::AllFonts)
...
class QFontComboBoxWrapper : public QFontComboBox, public cpgf::GScriptWrapper {
public:
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QFontComboBox::qt_metacast(__arg0);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QFontComboBox::qt_metacall(__arg0, __arg1, __arg2);
    }
...
template <typename D>
void buildMetaClass_QFontComboBoxWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    
    QFontComboBoxWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QFontComboBox<D>(config, _d);
}
