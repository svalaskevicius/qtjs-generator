...
#ifndef __META_QTWIDGETS_QITEMDELEGATE_H
#define __META_QTWIDGETS_QITEMDELEGATE_H
...
template <typename D>
void buildMetaClass_QItemDelegate(const cpgf::GMetaDataConfigFlags & config, D _d)
{
...
public:
    ...
    void drawFocus(QPainter * painter, const QStyleOptionViewItem & option, const QRect & rect) const
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunction(func.get(), this, painter, option, rect);
            return;
        }
    ...
    void drawDecoration(QPainter * painter, const QStyleOptionViewItem & option, const QRect & rect, const QPixmap & pixmap) const
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunction(func.get(), this, painter, option, rect, pixmap);
            return;
        }
    ...
    void drawCheck(QPainter * painter, const QStyleOptionViewItem & option, const QRect & rect, Qt::CheckState state) const
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunction(func.get(), this, painter, option, rect, state);
            return;
        }
    ...
    void drawDisplay(QPainter * painter, const QStyleOptionViewItem & option, const QRect & rect, const QString & text) const
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunction(func.get(), this, painter, option, rect, text);
            return;
        }
...
template <typename D>
void buildMetaClass_QItemDelegateWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
