...
#ifndef __META_QTWIDGETS_QSTATUSBAR_H
#define __META_QTWIDGETS_QSTATUSBAR_H
...
template <typename D>
void buildMetaClass_QStatusBar(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("insertWidget", &D::ClassType::insertWidget)
        ._default(copyVariantFromCopyable(0))
    ;
    _d.CPGF_MD_TEMPLATE _method("addPermanentWidget", &D::ClassType::addPermanentWidget)
        ._default(copyVariantFromCopyable(0))
    ;
    _d.CPGF_MD_TEMPLATE _method("insertPermanentWidget", &D::ClassType::insertPermanentWidget)
        ._default(copyVariantFromCopyable(0))
    ;
    _d.CPGF_MD_TEMPLATE _method("removeWidget", &D::ClassType::removeWidget);
    _d.CPGF_MD_TEMPLATE _method("setSizeGripEnabled", &D::ClassType::setSizeGripEnabled);
    _d.CPGF_MD_TEMPLATE _method("isSizeGripEnabled", &D::ClassType::isSizeGripEnabled);
    _d.CPGF_MD_TEMPLATE _method("currentMessage", &D::ClassType::currentMessage);
    _d.CPGF_MD_TEMPLATE _method("showMessage", &D::ClassType::showMessage, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >())
        ._default(copyVariantFromCopyable(0))
    ;
...
class QStatusBarWrapper : public QStatusBar, public cpgf::GScriptWrapper {
public:
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QStatusBar::qt_metacast(__arg0);
    }
    ...
    bool event(QEvent * __arg0)
    {
        ...
        return QStatusBar::event(__arg0);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QStatusBar::qt_metacall(__arg0, __arg1, __arg2);
    }
    ...
    static void cpgf__register(const cpgf::GMetaDataConfigFlags & config, D _d)
    {
        ...
        _d.CPGF_MD_TEMPLATE _method("reformat", (void (D::ClassType::*) ())&D::ClassType::reformat);
        ...
        _d.CPGF_MD_TEMPLATE _method("hideOrShow", (void (D::ClassType::*) ())&D::ClassType::hideOrShow);
...
template <typename D>
void buildMetaClass_QStatusBarWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    
    QStatusBarWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QStatusBar<D>(config, _d);
}
