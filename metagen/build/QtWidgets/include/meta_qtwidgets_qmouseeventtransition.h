...
#ifndef __META_QTWIDGETS_QMOUSEEVENTTRANSITION_H
#define __META_QTWIDGETS_QMOUSEEVENTTRANSITION_H
...
template <typename D>
void buildMetaClass_QMouseEventTransition(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    ...
    ;
    _d.CPGF_MD_TEMPLATE _constructor<void * (QObject *, QEvent::Type, Qt::MouseButton, QState *)>()
        ._default(copyVariantFromCopyable(0))
    ;
    ...
    _d.CPGF_MD_TEMPLATE _method("modifierMask", &D::ClassType::modifierMask);
    _d.CPGF_MD_TEMPLATE _method("setModifierMask", &D::ClassType::setModifierMask);
    _d.CPGF_MD_TEMPLATE _method("hitTestPath", &D::ClassType::hitTestPath);
    _d.CPGF_MD_TEMPLATE _method("setHitTestPath", &D::ClassType::setHitTestPath, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >());
...
class QMouseEventTransitionWrapper : public QMouseEventTransition, public cpgf::GScriptWrapper {
public:
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QMouseEventTransition::qt_metacall(__arg0, __arg1, __arg2);
    }
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QMouseEventTransition::qt_metacast(__arg0);
    }
...
template <typename D>
void buildMetaClass_QMouseEventTransitionWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    
    QMouseEventTransitionWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QMouseEventTransition<D>(config, _d);
}
