...
#ifndef CPGF_META_QTWIDGETS_QSIZEGRIP_H
#define CPGF_META_QTWIDGETS_QSIZEGRIP_H
...
template <typename D>
void buildMetaClass_QSizeGrip(D _d)
{
    (void)_d;
...
template <typename D>
void buildMetaClass_QSizeGripWrapper(D _d)
{
    (void)_d;
    using namespace cpgf;
    
    
    QSizeGripWrapper::cpgf__register(_d);
    
    buildMetaClass_QSizeGrip<D>(_d);
}
