...
#ifndef __META_QTWIDGETS_QSIZEGRIP_H
#define __META_QTWIDGETS_QSIZEGRIP_H
...
template <typename D>
void buildMetaClass_QSizeGrip(const cpgf::GMetaDataConfigFlags & config, D _d)
{
...
class QSizeGripWrapper : public QSizeGrip, public cpgf::GScriptWrapper {
public:
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QSizeGrip::qt_metacast(__arg0);
    }
    ...
    bool eventFilter(QObject * __arg0, QEvent * __arg1)
    {
        ...
        return QSizeGrip::eventFilter(__arg0, __arg1);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QSizeGrip::qt_metacall(__arg0, __arg1, __arg2);
    }
    ...
    void mouseMoveEvent(QMouseEvent * __arg0)
    {
        ...
        QSizeGrip::mouseMoveEvent(__arg0);
    }
    ...
    void setVisible(bool __arg0)
    {
        ...
        QSizeGrip::setVisible(__arg0);
    }
    void super_setVisible(bool __arg0)
    {
        QSizeGrip::setVisible(__arg0);
    }
    ...
    void mousePressEvent(QMouseEvent * __arg0)
    {
        ...
        QSizeGrip::mousePressEvent(__arg0);
    }
...
template <typename D>
void buildMetaClass_QSizeGripWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    
    QSizeGripWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QSizeGrip<D>(config, _d);
}
