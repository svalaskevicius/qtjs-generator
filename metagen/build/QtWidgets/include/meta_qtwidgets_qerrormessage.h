...
#ifndef __META_QTWIDGETS_QERRORMESSAGE_H
#define __META_QTWIDGETS_QERRORMESSAGE_H
...
template <typename D>
void buildMetaClass_QErrorMessage(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("showMessage", (void (D::ClassType::*) (const QString &))&D::ClassType::showMessage, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >());
    _d.CPGF_MD_TEMPLATE _method("showMessage", (void (D::ClassType::*) (const QString &, const QString &))&D::ClassType::showMessage, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0>, cpgf::GMetaRuleCopyConstReference<1> >());
    _d.CPGF_MD_TEMPLATE _method("tr", &D::ClassType::tr)
        ._default(copyVariantFromCopyable(-1))
        ._default(copyVariantFromCopyable(0))
    ;
    _d.CPGF_MD_TEMPLATE _method("qtHandler", &D::ClassType::qtHandler);
}


class QErrorMessageWrapper : public QErrorMessage, public cpgf::GScriptWrapper {
public:
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QErrorMessage::qt_metacast(__arg0);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QErrorMessage::qt_metacall(__arg0, __arg1, __arg2);
    }
...
template <typename D>
void buildMetaClass_QErrorMessageWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    
    QErrorMessageWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QErrorMessage<D>(config, _d);
}
