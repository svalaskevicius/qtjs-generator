...
#ifndef CPGF_META_QTWIDGETS_QERRORMESSAGE_H
#define CPGF_META_QTWIDGETS_QERRORMESSAGE_H
...
template <typename D>
void buildMetaClass_QErrorMessage(D _d)
{
    (void)_d;
...
template <typename D>
void buildMetaClass_QErrorMessageWrapper(D _d)
{
    (void)_d;
    using namespace cpgf;
    
    
    QErrorMessageWrapper::cpgf__register(_d);
    
    buildMetaClass_QErrorMessage<D>(_d);
}
