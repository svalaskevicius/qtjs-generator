...
#ifndef __META_QTWIDGETS_QDIALOG_H
#define __META_QTWIDGETS_QDIALOG_H
...
template <typename D>
void buildMetaClass_QDialog(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("setExtension", &D::ClassType::setExtension);
    _d.CPGF_MD_TEMPLATE _method("extension", &D::ClassType::extension);
    ...
    _d.CPGF_MD_TEMPLATE _method("setModal", &D::ClassType::setModal);
    _d.CPGF_MD_TEMPLATE _method("setResult", &D::ClassType::setResult);
    ...
    _d.CPGF_MD_TEMPLATE _method("reject", &D::ClassType::reject);
    _d.CPGF_MD_TEMPLATE _method("showExtension", &D::ClassType::showExtension);
    _d.CPGF_MD_TEMPLATE _method("tr", &D::ClassType::tr)
        ._default(copyVariantFromCopyable(-1))
        ._default(copyVariantFromCopyable(0))
    ;
    _d.CPGF_MD_TEMPLATE _enum<typename D::ClassType::DialogCode>("DialogCode")
        ._element("Rejected", D::ClassType::Rejected)
        ._element("Accepted", D::ClassType::Accepted)
    ;
}


class QDialogWrapper : public QDialog, public cpgf::GScriptWrapper {
public:
    
    QDialogWrapper(QWidget * parent = 0, Qt::WindowFlags f = 0)
        : QDialog(parent, f) {}
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QDialog::qt_metacast(__arg0);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QDialog::qt_metacall(__arg0, __arg1, __arg2);
    }
...
template <typename D>
void buildMetaClass_QDialogWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    
    QDialogWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QDialog<D>(config, _d);
}
