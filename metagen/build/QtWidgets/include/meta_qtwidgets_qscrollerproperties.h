...
#ifndef __META_QTWIDGETS_QSCROLLERPROPERTIES_H
#define __META_QTWIDGETS_QSCROLLERPROPERTIES_H
...
template <typename D>
void buildMetaClass_QScrollerProperties(const cpgf::GMetaDataConfigFlags & config, D _d)
{
