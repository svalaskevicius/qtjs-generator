...
#ifndef __META_QTWIDGETS_QPLAINTEXTEDIT_H
#define __META_QTWIDGETS_QPLAINTEXTEDIT_H
...
public:
    ...
    QRectF frameBoundingRect(QTextFrame * __arg0) const
    {
        ...
        if(func)
        {
            return cpgf::fromVariant<QRectF >(cpgf::invokeScriptFunction(func.get(), this, __arg0));
        }
    ...
    int hitTest(const QPointF & __arg0, Qt::HitTestAccuracy __arg1) const
    {
        ...
        if(func)
        {
            return cpgf::fromVariant<int >(cpgf::invokeScriptFunction(func.get(), this, __arg0, __arg1));
        }
