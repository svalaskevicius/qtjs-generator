...
template <typename D>
void buildMetaClass_QTextBrowser(const cpgf::GMetaDataConfigFlags & config, D _d)
{
...
template <typename D>
void buildMetaClass_QTextBrowserWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    
    QTextBrowserWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QTextBrowser<D>(config, _d);
}
