...
#ifndef CPGF_META_QTWIDGETS_QTREEVIEW_H
#define CPGF_META_QTWIDGETS_QTREEVIEW_H
...
template <typename D>
void buildMetaClass_QTreeView(D _d)
{
    (void)_d;
    ...
    _d.CPGF_MD_TEMPLATE _method("header", &D::ClassType::header);
    _d.CPGF_MD_TEMPLATE _method("setHeader", &D::ClassType::setHeader);
    _d.CPGF_MD_TEMPLATE _method("autoExpandDelay", &D::ClassType::autoExpandDelay);
    _d.CPGF_MD_TEMPLATE _method("setAutoExpandDelay", &D::ClassType::setAutoExpandDelay);
    _d.CPGF_MD_TEMPLATE _method("indentation", &D::ClassType::indentation);
    _d.CPGF_MD_TEMPLATE _method("setIndentation", &D::ClassType::setIndentation);
    _d.CPGF_MD_TEMPLATE _method("rootIsDecorated", &D::ClassType::rootIsDecorated);
    _d.CPGF_MD_TEMPLATE _method("setRootIsDecorated", &D::ClassType::setRootIsDecorated);
    _d.CPGF_MD_TEMPLATE _method("uniformRowHeights", &D::ClassType::uniformRowHeights);
    _d.CPGF_MD_TEMPLATE _method("setUniformRowHeights", &D::ClassType::setUniformRowHeights);
    _d.CPGF_MD_TEMPLATE _method("itemsExpandable", &D::ClassType::itemsExpandable);
    _d.CPGF_MD_TEMPLATE _method("setItemsExpandable", &D::ClassType::setItemsExpandable);
    _d.CPGF_MD_TEMPLATE _method("expandsOnDoubleClick", &D::ClassType::expandsOnDoubleClick);
    _d.CPGF_MD_TEMPLATE _method("setExpandsOnDoubleClick", &D::ClassType::setExpandsOnDoubleClick);
    _d.CPGF_MD_TEMPLATE _method("columnViewportPosition", &D::ClassType::columnViewportPosition);
    _d.CPGF_MD_TEMPLATE _method("columnWidth", &D::ClassType::columnWidth);
    _d.CPGF_MD_TEMPLATE _method("setColumnWidth", &D::ClassType::setColumnWidth);
    _d.CPGF_MD_TEMPLATE _method("columnAt", &D::ClassType::columnAt);
    _d.CPGF_MD_TEMPLATE _method("isColumnHidden", &D::ClassType::isColumnHidden);
    _d.CPGF_MD_TEMPLATE _method("setColumnHidden", &D::ClassType::setColumnHidden);
    _d.CPGF_MD_TEMPLATE _method("isHeaderHidden", &D::ClassType::isHeaderHidden);
    _d.CPGF_MD_TEMPLATE _method("setHeaderHidden", &D::ClassType::setHeaderHidden);
    ...
    _d.CPGF_MD_TEMPLATE _method("setAllColumnsShowFocus", &D::ClassType::setAllColumnsShowFocus);
    _d.CPGF_MD_TEMPLATE _method("allColumnsShowFocus", &D::ClassType::allColumnsShowFocus);
    _d.CPGF_MD_TEMPLATE _method("setWordWrap", &D::ClassType::setWordWrap);
    _d.CPGF_MD_TEMPLATE _method("wordWrap", &D::ClassType::wordWrap);
    _d.CPGF_MD_TEMPLATE _method("setTreePosition", &D::ClassType::setTreePosition);
    _d.CPGF_MD_TEMPLATE _method("treePosition", &D::ClassType::treePosition);
    ...
    _d.CPGF_MD_TEMPLATE _method("indexAbove", &D::ClassType::indexAbove);
    _d.CPGF_MD_TEMPLATE _method("indexBelow", &D::ClassType::indexBelow);
    _d.CPGF_MD_TEMPLATE _method("doItemsLayout", &D::ClassType::doItemsLayout);
    _d.CPGF_MD_TEMPLATE _method("reset", &D::ClassType::reset);
    _d.CPGF_MD_TEMPLATE _method("dataChanged", &D::ClassType::dataChanged, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<2> >())
        ._default(copyVariantFromCopyable(QVector< int >()))
    ;
    _d.CPGF_MD_TEMPLATE _method("selectAll", &D::ClassType::selectAll);
    _d.CPGF_MD_TEMPLATE _method("expanded", &D::ClassType::expanded);
    _d.CPGF_MD_TEMPLATE _method("collapsed", &D::ClassType::collapsed);
    _d.CPGF_MD_TEMPLATE _method("hideColumn", &D::ClassType::hideColumn);
    _d.CPGF_MD_TEMPLATE _method("showColumn", &D::ClassType::showColumn);
    _d.CPGF_MD_TEMPLATE _method("expand", &D::ClassType::expand);
    _d.CPGF_MD_TEMPLATE _method("collapse", &D::ClassType::collapse);
    _d.CPGF_MD_TEMPLATE _method("resizeColumnToContents", &D::ClassType::resizeColumnToContents);
    _d.CPGF_MD_TEMPLATE _method("expandAll", &D::ClassType::expandAll);
    _d.CPGF_MD_TEMPLATE _method("collapseAll", &D::ClassType::collapseAll);
    _d.CPGF_MD_TEMPLATE _method("expandToDepth", &D::ClassType::expandToDepth);
...
class QTreeViewWrapper : public QTreeView, public cpgf::GScriptWrapper {
public:
    ...
    void drawRow(QPainter * painter, const QStyleOptionViewItem & options, const QModelIndex & index) const
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunctionOnObject(func.get(), this, painter, options, index);
            return;
        }
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QTreeView::qt_metacast(__arg0);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QTreeView::qt_metacall(__arg0, __arg1, __arg2);
    }
    ...
    void drawBranches(QPainter * painter, const QRect & rect, const QModelIndex & index) const
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunctionOnObject(func.get(), this, painter, rect, index);
            return;
        }
...
template <typename D>
void buildMetaClass_QTreeViewWrapper(D _d)
{
    (void)_d;
    using namespace cpgf;
    
    
    QTreeViewWrapper::cpgf__register(_d);
    
    buildMetaClass_QTreeView<D>(_d);
}
