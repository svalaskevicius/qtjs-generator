...
#ifndef __META_QTWIDGETS_QABSTRACTSCROLLAREA_H
#define __META_QTWIDGETS_QABSTRACTSCROLLAREA_H
...
template <typename D>
void buildMetaClass_QAbstractScrollArea(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("verticalScrollBarPolicy", &D::ClassType::verticalScrollBarPolicy);
    _d.CPGF_MD_TEMPLATE _method("setVerticalScrollBarPolicy", &D::ClassType::setVerticalScrollBarPolicy);
    _d.CPGF_MD_TEMPLATE _method("verticalScrollBar", &D::ClassType::verticalScrollBar);
    _d.CPGF_MD_TEMPLATE _method("setVerticalScrollBar", &D::ClassType::setVerticalScrollBar);
    _d.CPGF_MD_TEMPLATE _method("horizontalScrollBarPolicy", &D::ClassType::horizontalScrollBarPolicy);
    _d.CPGF_MD_TEMPLATE _method("setHorizontalScrollBarPolicy", &D::ClassType::setHorizontalScrollBarPolicy);
    _d.CPGF_MD_TEMPLATE _method("horizontalScrollBar", &D::ClassType::horizontalScrollBar);
    _d.CPGF_MD_TEMPLATE _method("setHorizontalScrollBar", &D::ClassType::setHorizontalScrollBar);
    ...
    _d.CPGF_MD_TEMPLATE _method("addScrollBarWidget", &D::ClassType::addScrollBarWidget);
    _d.CPGF_MD_TEMPLATE _method("scrollBarWidgets", &D::ClassType::scrollBarWidgets);
    _d.CPGF_MD_TEMPLATE _method("viewport", &D::ClassType::viewport);
    _d.CPGF_MD_TEMPLATE _method("setViewport", &D::ClassType::setViewport);
    _d.CPGF_MD_TEMPLATE _method("maximumViewportSize", &D::ClassType::maximumViewportSize);
    ...
    _d.CPGF_MD_TEMPLATE _method("setupViewport", &D::ClassType::setupViewport);
    ...
    _d.CPGF_MD_TEMPLATE _enum<typename D::ClassType::SizeAdjustPolicy>("SizeAdjustPolicy")
        ._element("AdjustIgnored", D::ClassType::AdjustIgnored)
...
class QAbstractScrollAreaWrapper : public QAbstractScrollArea, public cpgf::GScriptWrapper {
public:
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QAbstractScrollArea::qt_metacast(__arg0);
    }
    ...
    void resizeEvent(QResizeEvent * __arg0)
    {
        ...
        QAbstractScrollArea::resizeEvent(__arg0);
    }
    ...
    bool event(QEvent * __arg0)
    {
        ...
        return QAbstractScrollArea::event(__arg0);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QAbstractScrollArea::qt_metacall(__arg0, __arg1, __arg2);
    }
...
template <typename D>
void buildMetaClass_QAbstractScrollAreaWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    
    QAbstractScrollAreaWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QAbstractScrollArea<D>(config, _d);
}
