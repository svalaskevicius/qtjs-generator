...
#ifndef CPGF_META_QTWIDGETS_QGROUPBOX_H
#define CPGF_META_QTWIDGETS_QGROUPBOX_H
...
class QGroupBoxWrapper : public QGroupBox, public cpgf::GScriptWrapper {
public:
    ...
    void super_childEvent(QChildEvent * event)
    {
        QGroupBox::childEvent(event);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QGroupBox::qt_metacall(__arg0, __arg1, __arg2);
    }
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QGroupBox::qt_metacast(__arg0);
    }
    ...
    static void cpgf__register(D _d)
    {
        ...
        _d.CPGF_MD_TEMPLATE _method("initStyleOption", (void (D::ClassType::*) (QStyleOptionGroupBox *) const)&D::ClassType::initStyleOption);
