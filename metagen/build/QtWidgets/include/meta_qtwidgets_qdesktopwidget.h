...
#ifndef CPGF_META_QTWIDGETS_QDESKTOPWIDGET_H
#define CPGF_META_QTWIDGETS_QDESKTOPWIDGET_H
...
template <typename D>
void buildMetaClass_QDesktopWidget(D _d)
{
    (void)_d;
...
template <typename D>
void buildMetaClass_QDesktopWidgetWrapper(D _d)
{
    (void)_d;
    using namespace cpgf;
    
    
    QDesktopWidgetWrapper::cpgf__register(_d);
    
    buildMetaClass_QDesktopWidget<D>(_d);
}
