...
#ifndef __META_QTWIDGETS_QLCDNUMBER_H
#define __META_QTWIDGETS_QLCDNUMBER_H
...
template <typename D>
void buildMetaClass_QLCDNumber(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    ...
    ;
    _d.CPGF_MD_TEMPLATE _constructor<void * (uint, QWidget *)>()
        ._default(copyVariantFromCopyable(0))
    ;
    ...
    _d.CPGF_MD_TEMPLATE _method("smallDecimalPoint", &D::ClassType::smallDecimalPoint);
    _d.CPGF_MD_TEMPLATE _method("digitCount", &D::ClassType::digitCount);
    _d.CPGF_MD_TEMPLATE _method("setDigitCount", &D::ClassType::setDigitCount);
    _d.CPGF_MD_TEMPLATE _method("checkOverflow", (bool (D::ClassType::*) (double) const)&D::ClassType::checkOverflow);
    _d.CPGF_MD_TEMPLATE _method("checkOverflow", (bool (D::ClassType::*) (int) const)&D::ClassType::checkOverflow);
    _d.CPGF_MD_TEMPLATE _method("mode", &D::ClassType::mode);
    _d.CPGF_MD_TEMPLATE _method("setMode", &D::ClassType::setMode);
    _d.CPGF_MD_TEMPLATE _method("segmentStyle", &D::ClassType::segmentStyle);
    _d.CPGF_MD_TEMPLATE _method("setSegmentStyle", &D::ClassType::setSegmentStyle);
    ...
    _d.CPGF_MD_TEMPLATE _method("display", (void (D::ClassType::*) (const QString &))&D::ClassType::display, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >());
    _d.CPGF_MD_TEMPLATE _method("display", (void (D::ClassType::*) (int))&D::ClassType::display);
    _d.CPGF_MD_TEMPLATE _method("display", (void (D::ClassType::*) (double))&D::ClassType::display);
    _d.CPGF_MD_TEMPLATE _method("setHexMode", &D::ClassType::setHexMode);
    _d.CPGF_MD_TEMPLATE _method("setDecMode", &D::ClassType::setDecMode);
    _d.CPGF_MD_TEMPLATE _method("setOctMode", &D::ClassType::setOctMode);
    _d.CPGF_MD_TEMPLATE _method("setBinMode", &D::ClassType::setBinMode);
    _d.CPGF_MD_TEMPLATE _method("setSmallDecimalPoint", &D::ClassType::setSmallDecimalPoint);
    _d.CPGF_MD_TEMPLATE _method("overflow", &D::ClassType::overflow);
    _d.CPGF_MD_TEMPLATE _method("tr", &D::ClassType::tr)
        ._default(copyVariantFromCopyable(-1))
        ._default(copyVariantFromCopyable(0))
    ;
    _d.CPGF_MD_TEMPLATE _enum<typename D::ClassType::Mode>("Mode")
        ._element("Hex", D::ClassType::Hex)
        ._element("Dec", D::ClassType::Dec)
        ._element("Oct", D::ClassType::Oct)
        ._element("Bin", D::ClassType::Bin)
    ;
    _d.CPGF_MD_TEMPLATE _enum<typename D::ClassType::SegmentStyle>("SegmentStyle")
        ._element("Outline", D::ClassType::Outline)
        ._element("Filled", D::ClassType::Filled)
        ._element("Flat", D::ClassType::Flat)
    ;
}


class QLCDNumberWrapper : public QLCDNumber, public cpgf::GScriptWrapper {
public:
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QLCDNumber::qt_metacast(__arg0);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QLCDNumber::qt_metacall(__arg0, __arg1, __arg2);
    }
...
template <typename D>
void buildMetaClass_QLCDNumberWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    
    QLCDNumberWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QLCDNumber<D>(config, _d);
}
