...
#ifndef CPGF_META_QTWIDGETS_QLCDNUMBER_H
#define CPGF_META_QTWIDGETS_QLCDNUMBER_H
...
template <typename D>
void buildMetaClass_QLCDNumber(D _d)
{
    (void)_d;
...
template <typename D>
void buildMetaClass_QLCDNumberWrapper(D _d)
{
    (void)_d;
    using namespace cpgf;
    
    
    QLCDNumberWrapper::cpgf__register(_d);
    
    buildMetaClass_QLCDNumber<D>(_d);
}
