...
#ifndef __META_QTWIDGETS_QDIAL_H
#define __META_QTWIDGETS_QDIAL_H
...
template <typename D>
void buildMetaClass_QDial(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("notchSize", &D::ClassType::notchSize);
    _d.CPGF_MD_TEMPLATE _method("setNotchTarget", &D::ClassType::setNotchTarget);
    _d.CPGF_MD_TEMPLATE _method("notchTarget", &D::ClassType::notchTarget);
    _d.CPGF_MD_TEMPLATE _method("notchesVisible", &D::ClassType::notchesVisible);
    ...
    _d.CPGF_MD_TEMPLATE _method("setNotchesVisible", &D::ClassType::setNotchesVisible);
...
class QDialWrapper : public QDial, public cpgf::GScriptWrapper {
public:
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QDial::qt_metacast(__arg0);
    }
    ...
    void resizeEvent(QResizeEvent * re)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunction(func.get(), this, re);
            return;
        }
        QDial::resizeEvent(re);
    }
    void super_resizeEvent(QResizeEvent * re)
    {
        QDial::resizeEvent(re);
    }
    ...
    void paintEvent(QPaintEvent * pe)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunction(func.get(), this, pe);
            return;
        }
        QDial::paintEvent(pe);
    }
    void super_paintEvent(QPaintEvent * pe)
    {
        QDial::paintEvent(pe);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QDial::qt_metacall(__arg0, __arg1, __arg2);
    }
    ...
    void mouseMoveEvent(QMouseEvent * me)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunction(func.get(), this, me);
            return;
        }
        QDial::mouseMoveEvent(me);
    }
    void super_mouseMoveEvent(QMouseEvent * me)
    {
        QDial::mouseMoveEvent(me);
    }
    ...
    void super_mousePressEvent(QMouseEvent * me)
    {
        QDial::mousePressEvent(me);
    }
    ...
    void super_mouseReleaseEvent(QMouseEvent * me)
    {
        QDial::mouseReleaseEvent(me);
    }
    ...
    static void cpgf__register(const cpgf::GMetaDataConfigFlags & config, D _d)
    {
        ...
        _d.CPGF_MD_TEMPLATE _method("initStyleOption", (void (D::ClassType::*) (QStyleOptionSlider *) const)&D::ClassType::initStyleOption);
...
template <typename D>
void buildMetaClass_QDialWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    
    QDialWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QDial<D>(config, _d);
}
