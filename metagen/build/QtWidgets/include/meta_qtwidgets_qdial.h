...
#ifndef CPGF_META_QTWIDGETS_QDIAL_H
#define CPGF_META_QTWIDGETS_QDIAL_H
...
template <typename D>
void buildMetaClass_QDial(D _d)
{
    (void)_d;
...
public:
    ...
    void resizeEvent(QResizeEvent * re)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunctionOnObject(func.get(), this, re);
            return;
        }
    ...
    void mouseReleaseEvent(QMouseEvent * me)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunctionOnObject(func.get(), this, me);
            return;
        }
    ...
    void paintEvent(QPaintEvent * pe)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunctionOnObject(func.get(), this, pe);
            return;
        }
        QDial::paintEvent(pe);
    }
...
template <typename D>
void buildMetaClass_QDialWrapper(D _d)
{
    (void)_d;
    using namespace cpgf;
    
    
    QDialWrapper::cpgf__register(_d);
    
    buildMetaClass_QDial<D>(_d);
}
