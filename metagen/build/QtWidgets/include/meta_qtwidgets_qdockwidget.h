...
#ifndef CPGF_META_QTWIDGETS_QDOCKWIDGET_H
#define CPGF_META_QTWIDGETS_QDOCKWIDGET_H
...
void buildMetaClass_QDockWidget(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("setFeatures", &D::ClassType::setFeatures);
    _d.CPGF_MD_TEMPLATE _method("features", &D::ClassType::features);
    _d.CPGF_MD_TEMPLATE _method("setFloating", &D::ClassType::setFloating);
    ...
    _d.CPGF_MD_TEMPLATE _method("setTitleBarWidget", &D::ClassType::setTitleBarWidget);
    _d.CPGF_MD_TEMPLATE _method("titleBarWidget", &D::ClassType::titleBarWidget);
    ...
    _d.CPGF_MD_TEMPLATE _method("featuresChanged", &D::ClassType::featuresChanged);
    ...
    _d.CPGF_MD_TEMPLATE _method("dockLocationChanged", &D::ClassType::dockLocationChanged);
    _d.CPGF_MD_TEMPLATE _method("tr", &D::ClassType::tr)
        ._default(copyVariantFromCopyable(-1))
        ._default(copyVariantFromCopyable(0))
    ;
    _d.CPGF_MD_TEMPLATE _enum<typename D::ClassType::DockWidgetFeature>("DockWidgetFeature")
        ._element("DockWidgetClosable", D::ClassType::DockWidgetClosable)
        ._element("DockWidgetMovable", D::ClassType::DockWidgetMovable)
        ._element("DockWidgetFloatable", D::ClassType::DockWidgetFloatable)
        ._element("DockWidgetVerticalTitleBar", D::ClassType::DockWidgetVerticalTitleBar)
        ._element("DockWidgetFeatureMask", D::ClassType::DockWidgetFeatureMask)
        ._element("AllDockWidgetFeatures", D::ClassType::AllDockWidgetFeatures)
        ._element("NoDockWidgetFeatures", D::ClassType::NoDockWidgetFeatures)
...
class QDockWidgetWrapper : public QDockWidget, public cpgf::GScriptWrapper {
public:
    
    QDockWidgetWrapper(const QString & title, QWidget * parent = 0, Qt::WindowFlags flags = 0)
        : QDockWidget(title, parent, flags) {}
    
    QDockWidgetWrapper(QWidget * parent = 0, Qt::WindowFlags flags = 0)
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QDockWidget::qt_metacall(__arg0, __arg1, __arg2);
    }
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QDockWidget::qt_metacast(__arg0);
    }
