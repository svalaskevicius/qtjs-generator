...
#ifndef CPGF_META_QTWIDGETS_QABSTRACTBUTTON_H
#define CPGF_META_QTWIDGETS_QABSTRACTBUTTON_H
...
void buildMetaClass_QAbstractButton(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("setDown", &D::ClassType::setDown);
    _d.CPGF_MD_TEMPLATE _method("isDown", &D::ClassType::isDown);
    ...
    _d.CPGF_MD_TEMPLATE _method("setAutoRepeatDelay", &D::ClassType::setAutoRepeatDelay);
    _d.CPGF_MD_TEMPLATE _method("autoRepeatDelay", &D::ClassType::autoRepeatDelay);
    _d.CPGF_MD_TEMPLATE _method("setAutoRepeatInterval", &D::ClassType::setAutoRepeatInterval);
    _d.CPGF_MD_TEMPLATE _method("autoRepeatInterval", &D::ClassType::autoRepeatInterval);
    _d.CPGF_MD_TEMPLATE _method("setAutoExclusive", &D::ClassType::setAutoExclusive);
    _d.CPGF_MD_TEMPLATE _method("autoExclusive", &D::ClassType::autoExclusive);
    _d.CPGF_MD_TEMPLATE _method("group", &D::ClassType::group);
    _d.CPGF_MD_TEMPLATE _method("setIconSize", &D::ClassType::setIconSize);
    _d.CPGF_MD_TEMPLATE _method("animateClick", &D::ClassType::animateClick)
        ._default(copyVariantFromCopyable(100))
    ;
    _d.CPGF_MD_TEMPLATE _method("click", &D::ClassType::click);
    _d.CPGF_MD_TEMPLATE _method("toggle", &D::ClassType::toggle);
    _d.CPGF_MD_TEMPLATE _method("setChecked", &D::ClassType::setChecked);
    _d.CPGF_MD_TEMPLATE _method("pressed", &D::ClassType::pressed);
    _d.CPGF_MD_TEMPLATE _method("released", &D::ClassType::released);
...
class QAbstractButtonWrapper : public QAbstractButton, public cpgf::GScriptWrapper {
public:
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QAbstractButton::qt_metacall(__arg0, __arg1, __arg2);
    }
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QAbstractButton::qt_metacast(__arg0);
    }
