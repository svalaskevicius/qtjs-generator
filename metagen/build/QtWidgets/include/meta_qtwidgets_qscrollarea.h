...
#ifndef __META_QTWIDGETS_QSCROLLAREA_H
#define __META_QTWIDGETS_QSCROLLAREA_H
...
template <typename D>
void buildMetaClass_QScrollArea(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("takeWidget", &D::ClassType::takeWidget);
    _d.CPGF_MD_TEMPLATE _method("widgetResizable", &D::ClassType::widgetResizable);
    _d.CPGF_MD_TEMPLATE _method("setWidgetResizable", &D::ClassType::setWidgetResizable);
    _d.CPGF_MD_TEMPLATE _method("sizeHint", &D::ClassType::sizeHint);
    _d.CPGF_MD_TEMPLATE _method("focusNextPrevChild", &D::ClassType::focusNextPrevChild);
    ...
    _d.CPGF_MD_TEMPLATE _method("ensureVisible", &D::ClassType::ensureVisible)
        ._default(copyVariantFromCopyable(50))
        ._default(copyVariantFromCopyable(50))
    ;
    _d.CPGF_MD_TEMPLATE _method("ensureWidgetVisible", &D::ClassType::ensureWidgetVisible)
        ._default(copyVariantFromCopyable(50))
        ._default(copyVariantFromCopyable(50))
    ;
...
class QScrollAreaWrapper : public QScrollArea, public cpgf::GScriptWrapper {
public:
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QScrollArea::qt_metacast(__arg0);
    }
    ...
    void resizeEvent(QResizeEvent * __arg0)
    {
        ...
        QScrollArea::resizeEvent(__arg0);
    }
    ...
    bool event(QEvent * __arg0)
    {
        ...
        return QScrollArea::event(__arg0);
    }
    ...
    bool eventFilter(QObject * __arg0, QEvent * __arg1)
    {
        ...
        return QScrollArea::eventFilter(__arg0, __arg1);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QScrollArea::qt_metacall(__arg0, __arg1, __arg2);
    }
...
template <typename D>
void buildMetaClass_QScrollAreaWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    
    QScrollAreaWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QScrollArea<D>(config, _d);
}
