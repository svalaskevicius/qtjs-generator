...
#ifndef CPGF_META_QTWIDGETS_QSCROLLAREA_H
#define CPGF_META_QTWIDGETS_QSCROLLAREA_H
...
template <typename D>
void buildMetaClass_QScrollArea(D _d)
{
    (void)_d;
...
template <typename D>
void buildMetaClass_QScrollAreaWrapper(D _d)
{
    (void)_d;
    using namespace cpgf;
    
    
    QScrollAreaWrapper::cpgf__register(_d);
    
    buildMetaClass_QScrollArea<D>(_d);
}
