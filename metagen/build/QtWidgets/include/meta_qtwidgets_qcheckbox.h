...
#ifndef __META_QTWIDGETS_QCHECKBOX_H
#define __META_QTWIDGETS_QCHECKBOX_H
...
template <typename D>
void buildMetaClass_QCheckBox(const cpgf::GMetaDataConfigFlags & config, D _d)
{
...
class QCheckBoxWrapper : public QCheckBox, public cpgf::GScriptWrapper {
public:
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QCheckBox::qt_metacast(__arg0);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QCheckBox::qt_metacall(__arg0, __arg1, __arg2);
    }
    ...
    void mouseMoveEvent(QMouseEvent * __arg0)
    {
        ...
        QCheckBox::mouseMoveEvent(__arg0);
    }
...
template <typename D>
void buildMetaClass_QCheckBoxWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    
    QCheckBoxWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QCheckBox<D>(config, _d);
}
