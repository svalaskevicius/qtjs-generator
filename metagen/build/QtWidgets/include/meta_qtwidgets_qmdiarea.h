...
#ifndef CPGF_META_QTWIDGETS_QMDIAREA_H
#define CPGF_META_QTWIDGETS_QMDIAREA_H
...
template <typename D>
void buildMetaClass_QMdiArea(D _d)
{
    (void)_d;
...
template <typename D>
void buildMetaClass_QMdiAreaWrapper(D _d)
{
    (void)_d;
    using namespace cpgf;
    
    
    QMdiAreaWrapper::cpgf__register(_d);
    
    buildMetaClass_QMdiArea<D>(_d);
}
