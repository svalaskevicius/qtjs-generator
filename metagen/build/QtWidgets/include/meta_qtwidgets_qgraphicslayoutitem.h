...
#ifndef __META_QTWIDGETS_QGRAPHICSLAYOUTITEM_H
#define __META_QTWIDGETS_QGRAPHICSLAYOUTITEM_H
...
template <typename D>
void buildMetaClass_QGraphicsLayoutItem(const cpgf::GMetaDataConfigFlags & config, D _d)
{
