...
#ifndef __META_QTWIDGETS_QTOOLBAR_H
#define __META_QTWIDGETS_QTOOLBAR_H
...
template <typename D>
void buildMetaClass_QToolBar(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("setAllowedAreas", &D::ClassType::setAllowedAreas);
    _d.CPGF_MD_TEMPLATE _method("allowedAreas", &D::ClassType::allowedAreas);
    _d.CPGF_MD_TEMPLATE _method("isAreaAllowed", &D::ClassType::isAreaAllowed);
    ...
    _d.CPGF_MD_TEMPLATE _method("addAction", (QAction * (D::ClassType::*) (const QIcon &, const QString &, const QObject *, const char *))&D::ClassType::addAction, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0>, cpgf::GMetaRuleCopyConstReference<1> >());
    ...
    _d.CPGF_MD_TEMPLATE _method("actionAt", (QAction * (D::ClassType::*) (const QPoint &) const)&D::ClassType::actionAt);
    _d.CPGF_MD_TEMPLATE _method("actionAt", (QAction * (D::ClassType::*) (int, int) const)&D::ClassType::actionAt);
    _d.CPGF_MD_TEMPLATE _method("toggleViewAction", &D::ClassType::toggleViewAction);
    ...
    _d.CPGF_MD_TEMPLATE _method("widgetForAction", &D::ClassType::widgetForAction);
    _d.CPGF_MD_TEMPLATE _method("isFloatable", &D::ClassType::isFloatable);
    _d.CPGF_MD_TEMPLATE _method("setFloatable", &D::ClassType::setFloatable);
    _d.CPGF_MD_TEMPLATE _method("isFloating", &D::ClassType::isFloating);
    ...
    _d.CPGF_MD_TEMPLATE _method("movableChanged", &D::ClassType::movableChanged);
    _d.CPGF_MD_TEMPLATE _method("allowedAreasChanged", &D::ClassType::allowedAreasChanged);
    ...
    _d.CPGF_MD_TEMPLATE _method("topLevelChanged", &D::ClassType::topLevelChanged);
...
class QToolBarWrapper : public QToolBar, public cpgf::GScriptWrapper {
public:
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QToolBar::qt_metacast(__arg0);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QToolBar::qt_metacall(__arg0, __arg1, __arg2);
    }
    ...
    void super_actionEvent(QActionEvent * event)
    {
        QToolBar::actionEvent(event);
    }
    ...
    static void cpgf__register(const cpgf::GMetaDataConfigFlags & config, D _d)
    {
        ...
        _d.CPGF_MD_TEMPLATE _method("initStyleOption", (void (D::ClassType::*) (QStyleOptionToolBar *) const)&D::ClassType::initStyleOption);
...
template <typename D>
void buildMetaClass_QToolBarWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    
    QToolBarWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QToolBar<D>(config, _d);
}
