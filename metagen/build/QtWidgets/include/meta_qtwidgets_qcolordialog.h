...
#ifndef __META_QTWIDGETS_QCOLORDIALOG_H
...
template <typename D>
void buildMetaClass_QColorDialog(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    ...
    ;
    _d.CPGF_MD_TEMPLATE _constructor<void * (const QColor &, QWidget *)>(cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >())
        ._default(copyVariantFromCopyable(0))
    ;
    ...
    _d.CPGF_MD_TEMPLATE _method("setCurrentColor", &D::ClassType::setCurrentColor, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >());
    _d.CPGF_MD_TEMPLATE _method("currentColor", &D::ClassType::currentColor);
    _d.CPGF_MD_TEMPLATE _method("selectedColor", &D::ClassType::selectedColor);
    ...
    _d.CPGF_MD_TEMPLATE _method("currentColorChanged", &D::ClassType::currentColorChanged, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >());
    _d.CPGF_MD_TEMPLATE _method("colorSelected", &D::ClassType::colorSelected, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >());
    _d.CPGF_MD_TEMPLATE _method("tr", &D::ClassType::tr)
        ._default(copyVariantFromCopyable(-1))
        ._default(copyVariantFromCopyable(0))
    ;
    _d.CPGF_MD_TEMPLATE _method("getColor", &D::ClassType::getColor, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0>, cpgf::GMetaRuleCopyConstReference<2> >())
        ._default(copyVariantFromCopyable(0))
        ._default(copyVariantFromCopyable(QString()))
        ._default(copyVariantFromCopyable(0))
        ._default(copyVariantFromCopyable(Qt::white))
    ;
    _d.CPGF_MD_TEMPLATE _method("getRgba", &D::ClassType::getRgba)
        ._default(copyVariantFromCopyable(0))
        ._default(copyVariantFromCopyable(0))
        ._default(copyVariantFromCopyable(0xffffffff))
    ;
    _d.CPGF_MD_TEMPLATE _method("customCount", &D::ClassType::customCount);
    _d.CPGF_MD_TEMPLATE _method("customColor", &D::ClassType::customColor);
    _d.CPGF_MD_TEMPLATE _method("setCustomColor", &D::ClassType::setCustomColor);
    _d.CPGF_MD_TEMPLATE _method("standardColor", &D::ClassType::standardColor);
    _d.CPGF_MD_TEMPLATE _method("setStandardColor", &D::ClassType::setStandardColor);
    _d.CPGF_MD_TEMPLATE _enum<typename D::ClassType::ColorDialogOption>("ColorDialogOption")
        ._element("ShowAlphaChannel", D::ClassType::ShowAlphaChannel)
...
class QColorDialogWrapper : public QColorDialog, public cpgf::GScriptWrapper {
public:
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QColorDialog::qt_metacast(__arg0);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QColorDialog::qt_metacall(__arg0, __arg1, __arg2);
    }
...
template <typename D>
void buildMetaClass_QColorDialogWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    
    QColorDialogWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QColorDialog<D>(config, _d);
}
