...
#ifndef __META_QTWIDGETS_QCOLUMNVIEW_H
#define __META_QTWIDGETS_QCOLUMNVIEW_H
...
template <typename D>
void buildMetaClass_QColumnView(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("updatePreviewWidget", &D::ClassType::updatePreviewWidget);
    ...
    _d.CPGF_MD_TEMPLATE _method("setResizeGripsVisible", &D::ClassType::setResizeGripsVisible);
    _d.CPGF_MD_TEMPLATE _method("resizeGripsVisible", &D::ClassType::resizeGripsVisible);
    _d.CPGF_MD_TEMPLATE _method("previewWidget", &D::ClassType::previewWidget);
    _d.CPGF_MD_TEMPLATE _method("setPreviewWidget", &D::ClassType::setPreviewWidget);
    _d.CPGF_MD_TEMPLATE _method("setColumnWidths", &D::ClassType::setColumnWidths);
    _d.CPGF_MD_TEMPLATE _method("columnWidths", &D::ClassType::columnWidths);
...
class QColumnViewWrapper : public QColumnView, public cpgf::GScriptWrapper {
public:
    ...
    QModelIndex indexAt(const QPoint & point) const
    {
        ...
        if(func)
        {
            return cpgf::fromVariant<QModelIndex >(cpgf::invokeScriptFunction(func.get(), this, point));
        }
    ...
    {
        cpgf::GScopedInterface<cpgf::IScriptFunction> func(this->getScriptFunction("createColumn"));
        if(func)
        {
            return cpgf::fromVariant<QAbstractItemView * >(cpgf::invokeScriptFunction(func.get(), this, rootIndex));
        }
        return QColumnView::createColumn(rootIndex);
    }
    QAbstractItemView * super_createColumn(const QModelIndex & rootIndex)
    {
        return QColumnView::createColumn(rootIndex);
    }
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QColumnView::qt_metacast(__arg0);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QColumnView::qt_metacall(__arg0, __arg1, __arg2);
    }
    ...
    static void cpgf__register(const cpgf::GMetaDataConfigFlags & config, D _d)
    {
        ...
        _d.CPGF_MD_TEMPLATE _method("initializeColumn", (void (D::ClassType::*) (QAbstractItemView *) const)&D::ClassType::initializeColumn);
        ...
        _d.CPGF_MD_TEMPLATE _method("createColumn", (QAbstractItemView * (D::ClassType::*) (const QModelIndex &))&D::ClassType::createColumn);
        ...
        _d.CPGF_MD_TEMPLATE _method("super_createColumn", (QAbstractItemView * (D::ClassType::*) (const QModelIndex &))&D::ClassType::super_createColumn);
...
template <typename D>
void buildMetaClass_QColumnViewWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    
    QColumnViewWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QColumnView<D>(config, _d);
}
