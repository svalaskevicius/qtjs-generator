...
#ifndef CPGF_META_QTWIDGETS_QCOLUMNVIEW_H
#define CPGF_META_QTWIDGETS_QCOLUMNVIEW_H
...
template <typename D>
void buildMetaClass_QColumnView(D _d)
{
    (void)_d;
...
public:
    ...
    QModelIndex indexAt(const QPoint & point) const
    {
        ...
        if(func)
        {
            return cpgf::fromVariant<QModelIndex >(cpgf::invokeScriptFunction(func.get(), this, point).getValue());
        }
    ...
    QAbstractItemView * createColumn(const QModelIndex & rootIndex)
    {
        ...
        if(func)
        {
            return cpgf::fromVariant<QAbstractItemView * >(cpgf::invokeScriptFunction(func.get(), this, rootIndex).getValue());
        }
...
template <typename D>
void buildMetaClass_QColumnViewWrapper(D _d)
{
    (void)_d;
    using namespace cpgf;
    
    
    QColumnViewWrapper::cpgf__register(_d);
    
    buildMetaClass_QColumnView<D>(_d);
}
