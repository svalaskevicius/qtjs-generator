...
#ifndef __META_QTWIDGETS_QACCESSIBLEWIDGET_H
#define __META_QTWIDGETS_QACCESSIBLEWIDGET_H
...
public:
    ...
    int indexOfChild(const QAccessibleInterface * child) const
    {
        ...
        if(func)
        {
            return cpgf::fromVariant<int >(cpgf::invokeScriptFunction(func.get(), this, child));
        }
    ...
    void * interface_cast(QAccessible::InterfaceType t)
    {
        ...
        if(func)
        {
            return cpgf::fromVariant<void * >(cpgf::invokeScriptFunction(func.get(), this, t));
        }
