...
#ifndef CPGF_META_QTWIDGETS_QSCROLLBAR_H
#define CPGF_META_QTWIDGETS_QSCROLLBAR_H
...
class QScrollBarWrapper : public QScrollBar, public cpgf::GScriptWrapper {
public:
    
    QScrollBarWrapper(QWidget * parent = 0)
        : QScrollBar(parent) {}
    
    QScrollBarWrapper(Qt::Orientation __arg0, QWidget * parent = 0)
        : QScrollBar(__arg0, parent) {}
    ...
    void mouseReleaseEvent(QMouseEvent * __arg0)
    {
        ...
        QScrollBar::mouseReleaseEvent(__arg0);
    }
    ...
    void contextMenuEvent(QContextMenuEvent * __arg0)
    {
        ...
        QScrollBar::contextMenuEvent(__arg0);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QScrollBar::qt_metacall(__arg0, __arg1, __arg2);
    }
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QScrollBar::qt_metacast(__arg0);
    }
    ...
    void mouseMoveEvent(QMouseEvent * __arg0)
    {
        ...
        QScrollBar::mouseMoveEvent(__arg0);
    }
    ...
    void mousePressEvent(QMouseEvent * __arg0)
    {
        ...
        QScrollBar::mousePressEvent(__arg0);
    }
