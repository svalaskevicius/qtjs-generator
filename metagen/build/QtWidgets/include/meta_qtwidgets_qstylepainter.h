...
#ifndef __META_QTWIDGETS_QSTYLEPAINTER_H
#define __META_QTWIDGETS_QSTYLEPAINTER_H
...
template <typename D>
void buildMetaClass_QStylePainter(const cpgf::GMetaDataConfigFlags & config, D _d)
{
