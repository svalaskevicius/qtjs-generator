...
#ifndef CPGF_META_QTWIDGETS_QFILESYSTEMMODEL_H
#define CPGF_META_QTWIDGETS_QFILESYSTEMMODEL_H
...
void buildMetaClass_QFileSystemModel(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("rootPathChanged", &D::ClassType::rootPathChanged, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >());
    _d.CPGF_MD_TEMPLATE _method("fileRenamed", &D::ClassType::fileRenamed, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0>, cpgf::GMetaRuleCopyConstReference<1>, cpgf::GMetaRuleCopyConstReference<2> >());
    _d.CPGF_MD_TEMPLATE _method("directoryLoaded", &D::ClassType::directoryLoaded, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >());
    ...
    _d.CPGF_MD_TEMPLATE _method("hasChildren", &D::ClassType::hasChildren)
        ._default(copyVariantFromCopyable(QModelIndex()))
    ;
    _d.CPGF_MD_TEMPLATE _method("canFetchMore", &D::ClassType::canFetchMore);
    _d.CPGF_MD_TEMPLATE _method("fetchMore", &D::ClassType::fetchMore);
    ...
    _d.CPGF_MD_TEMPLATE _method("columnCount", &D::ClassType::columnCount)
        ._default(copyVariantFromCopyable(QModelIndex()))
    ;
    _d.CPGF_MD_TEMPLATE _method("myComputer", &D::ClassType::myComputer)
    ...
    _d.CPGF_MD_TEMPLATE _method("setRootPath", &D::ClassType::setRootPath, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >());
    _d.CPGF_MD_TEMPLATE _method("rootPath", &D::ClassType::rootPath);
    _d.CPGF_MD_TEMPLATE _method("rootDirectory", &D::ClassType::rootDirectory);
    ...
    _d.CPGF_MD_TEMPLATE _method("setNameFilterDisables", &D::ClassType::setNameFilterDisables);
    _d.CPGF_MD_TEMPLATE _method("nameFilterDisables", &D::ClassType::nameFilterDisables);
    ...
    _d.CPGF_MD_TEMPLATE _enum<typename D::ClassType::Roles>("Roles")
        ...
        ._element("FilePermissions", D::ClassType::FilePermissions)
    ;
}


class QFileSystemModelWrapper : public QFileSystemModel, public cpgf::GScriptWrapper {
public:
