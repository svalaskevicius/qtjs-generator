...
#ifndef __META_QTWIDGETS_QRUBBERBAND_H
#define __META_QTWIDGETS_QRUBBERBAND_H
...
template <typename D>
void buildMetaClass_QRubberBand(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    _d.CPGF_MD_TEMPLATE _constructor<void * (QRubberBand::Shape, QWidget *)>()
...
class QRubberBandWrapper : public QRubberBand, public cpgf::GScriptWrapper {
public:
    
    QRubberBandWrapper(QRubberBand::Shape __arg0, QWidget * __arg1 = 0)
        : QRubberBand(__arg0, __arg1) {}
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QRubberBand::qt_metacast(__arg0);
    }
    ...
    void resizeEvent(QResizeEvent * __arg0)
    {
        ...
        QRubberBand::resizeEvent(__arg0);
    }
    ...
    void changeEvent(QEvent * __arg0)
    {
        ...
        QRubberBand::changeEvent(__arg0);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QRubberBand::qt_metacall(__arg0, __arg1, __arg2);
    }
    ...
    static void cpgf__register(const cpgf::GMetaDataConfigFlags & config, D _d)
    {
        ...
        _d.CPGF_MD_TEMPLATE _method("initStyleOption", (void (D::ClassType::*) (QStyleOptionRubberBand *) const)&D::ClassType::initStyleOption);
...
template <typename D>
void buildMetaClass_QRubberBandWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    
    QRubberBandWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QRubberBand<D>(config, _d);
}
