...
#ifndef CPGF_META_QTWIDGETS_QRUBBERBAND_H
#define CPGF_META_QTWIDGETS_QRUBBERBAND_H
...
template <typename D>
void buildMetaClass_QRubberBand(D _d)
{
    (void)_d;
...
template <typename D>
void buildMetaClass_QRubberBandWrapper(D _d)
{
    (void)_d;
    using namespace cpgf;
    
    
    QRubberBandWrapper::cpgf__register(_d);
    
    buildMetaClass_QRubberBand<D>(_d);
}
