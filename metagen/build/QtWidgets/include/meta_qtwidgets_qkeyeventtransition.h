...
#ifndef __META_QTWIDGETS_QKEYEVENTTRANSITION_H
#define __META_QTWIDGETS_QKEYEVENTTRANSITION_H
...
template <typename D>
void buildMetaClass_QKeyEventTransition(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    ...
    ;
    _d.CPGF_MD_TEMPLATE _constructor<void * (QObject *, QEvent::Type, int, QState *)>()
        ._default(copyVariantFromCopyable(0))
    ;
    ...
    _d.CPGF_MD_TEMPLATE _method("setKey", &D::ClassType::setKey);
...
class QKeyEventTransitionWrapper : public QKeyEventTransition, public cpgf::GScriptWrapper {
public:
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QKeyEventTransition::qt_metacall(__arg0, __arg1, __arg2);
    }
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QKeyEventTransition::qt_metacast(__arg0);
    }
...
template <typename D>
void buildMetaClass_QKeyEventTransitionWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    
    QKeyEventTransitionWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QKeyEventTransition<D>(config, _d);
}
