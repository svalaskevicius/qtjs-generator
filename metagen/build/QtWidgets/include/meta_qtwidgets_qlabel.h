...
#ifndef __META_QTWIDGETS_QLABEL_H
#define __META_QTWIDGETS_QLABEL_H
...
template <typename D>
void buildMetaClass_QLabel(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("pixmap", &D::ClassType::pixmap);
    _d.CPGF_MD_TEMPLATE _method("picture", &D::ClassType::picture);
    _d.CPGF_MD_TEMPLATE _method("movie", &D::ClassType::movie);
    ...
    _d.CPGF_MD_TEMPLATE _method("hasScaledContents", &D::ClassType::hasScaledContents);
    _d.CPGF_MD_TEMPLATE _method("setScaledContents", &D::ClassType::setScaledContents);
    ...
    _d.CPGF_MD_TEMPLATE _method("setBuddy", &D::ClassType::setBuddy);
    _d.CPGF_MD_TEMPLATE _method("buddy", &D::ClassType::buddy);
    ...
    _d.CPGF_MD_TEMPLATE _method("setMovie", &D::ClassType::setMovie);
    _d.CPGF_MD_TEMPLATE _method("setNum", (void (D::ClassType::*) (int))&D::ClassType::setNum);
    _d.CPGF_MD_TEMPLATE _method("setNum", (void (D::ClassType::*) (double))&D::ClassType::setNum);
...
class QLabelWrapper : public QLabel, public cpgf::GScriptWrapper {
public:
    
    QLabelWrapper(QWidget * parent = 0, Qt::WindowFlags f = 0)
        : QLabel(parent, f) {}
    
    QLabelWrapper(const QString & text, QWidget * parent = 0, Qt::WindowFlags f = 0)
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QLabel::qt_metacast(__arg0);
    }
    ...
    void super_focusInEvent(QFocusEvent * ev)
    {
        QLabel::focusInEvent(ev);
    }
    ...
    void super_contextMenuEvent(QContextMenuEvent * ev)
    {
        QLabel::contextMenuEvent(ev);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QLabel::qt_metacall(__arg0, __arg1, __arg2);
    }
    ...
    int heightForWidth(int __arg0) const
    {
        ...
        return QLabel::heightForWidth(__arg0);
    }
...
template <typename D>
void buildMetaClass_QLabelWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    
    QLabelWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QLabel<D>(config, _d);
}
