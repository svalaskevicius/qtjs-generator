...
#ifndef CPGF_META_QTWIDGETS_QPROGRESSDIALOG_H
#define CPGF_META_QTWIDGETS_QPROGRESSDIALOG_H
...
template <typename D>
void buildMetaClass_QProgressDialog(D _d)
{
    (void)_d;
...
template <typename D>
void buildMetaClass_QProgressDialogWrapper(D _d)
{
    (void)_d;
    using namespace cpgf;
    
    
    QProgressDialogWrapper::cpgf__register(_d);
    
    buildMetaClass_QProgressDialog<D>(_d);
}
