...
#ifndef __META_QTWIDGETS_QPROGRESSDIALOG_H
#define __META_QTWIDGETS_QPROGRESSDIALOG_H
...
template <typename D>
void buildMetaClass_QProgressDialog(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _constructor<void * (QWidget *, Qt::WindowFlags)>()
        ...
        ._default(copyVariantFromCopyable(0))
    ;
    _d.CPGF_MD_TEMPLATE _constructor<void * (const QString &, const QString &, int, int, QWidget *, Qt::WindowFlags)>(cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0>, cpgf::GMetaRuleCopyConstReference<1> >())
        ._default(copyVariantFromCopyable(0))
        ._default(copyVariantFromCopyable(0))
    ;
    ...
    _d.CPGF_MD_TEMPLATE _method("setLabel", &D::ClassType::setLabel);
    _d.CPGF_MD_TEMPLATE _method("setCancelButton", &D::ClassType::setCancelButton);
    _d.CPGF_MD_TEMPLATE _method("setBar", &D::ClassType::setBar);
    _d.CPGF_MD_TEMPLATE _method("wasCanceled", &D::ClassType::wasCanceled);
    ...
    _d.CPGF_MD_TEMPLATE _method("minimumDuration", &D::ClassType::minimumDuration);
    _d.CPGF_MD_TEMPLATE _method("setAutoReset", &D::ClassType::setAutoReset);
    _d.CPGF_MD_TEMPLATE _method("autoReset", &D::ClassType::autoReset);
    _d.CPGF_MD_TEMPLATE _method("setAutoClose", &D::ClassType::setAutoClose);
    _d.CPGF_MD_TEMPLATE _method("autoClose", &D::ClassType::autoClose);
    ...
    _d.CPGF_MD_TEMPLATE _method("setMinimumDuration", &D::ClassType::setMinimumDuration);
    _d.CPGF_MD_TEMPLATE _method("canceled", &D::ClassType::canceled);
...
class QProgressDialogWrapper : public QProgressDialog, public cpgf::GScriptWrapper {
public:
    
    QProgressDialogWrapper(QWidget * parent = 0, Qt::WindowFlags flags = 0)
        : QProgressDialog(parent, flags) {}
    
    QProgressDialogWrapper(const QString & labelText, const QString & cancelButtonText, int minimum, int maximum, QWidget * parent = 0, Qt::WindowFlags flags = 0)
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QProgressDialog::qt_metacast(__arg0);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QProgressDialog::qt_metacall(__arg0, __arg1, __arg2);
    }
    ...
    static void cpgf__register(const cpgf::GMetaDataConfigFlags & config, D _d)
    {
        ...
        _d.CPGF_MD_TEMPLATE _method("forceShow", (void (D::ClassType::*) ())&D::ClassType::forceShow);
...
template <typename D>
void buildMetaClass_QProgressDialogWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    
    QProgressDialogWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QProgressDialog<D>(config, _d);
}
