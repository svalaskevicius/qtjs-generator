...
#ifndef CPGF_META_QTWIDGETS_QTREEWIDGET_H
#define CPGF_META_QTWIDGETS_QTREEWIDGET_H
...
public:
    ...
    QMimeData * mimeData(const QList< QTreeWidgetItem * > items) const
    {
        ...
        if(func)
        {
            return cpgf::fromVariant<QMimeData * >(cpgf::invokeScriptFunctionOnObject(func.get(), this, items).getValue());
        }
    ...
    bool dropMimeData(QTreeWidgetItem * parent, int index, const QMimeData * data, Qt::DropAction action)
    {
        ...
        if(func)
        {
            return cpgf::fromVariant<bool >(cpgf::invokeScriptFunctionOnObject(func.get(), this, parent, index, data, action).getValue());
        }
