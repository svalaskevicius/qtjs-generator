...
#ifndef __META_QTWIDGETS_QSLIDER_H
#define __META_QTWIDGETS_QSLIDER_H
...
template <typename D>
void buildMetaClass_QSlider(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("setTickPosition", &D::ClassType::setTickPosition);
    _d.CPGF_MD_TEMPLATE _method("tickPosition", &D::ClassType::tickPosition);
    _d.CPGF_MD_TEMPLATE _method("setTickInterval", &D::ClassType::setTickInterval);
    _d.CPGF_MD_TEMPLATE _method("tickInterval", &D::ClassType::tickInterval);
    _d.CPGF_MD_TEMPLATE _method("event", &D::ClassType::event);
    _d.CPGF_MD_TEMPLATE _method("tr", &D::ClassType::tr)
        ._default(copyVariantFromCopyable(-1))
        ._default(copyVariantFromCopyable(0))
    ;
    _d.CPGF_MD_TEMPLATE _enum<typename D::ClassType::TickPosition>("TickPosition")
        ._element("NoTicks", D::ClassType::NoTicks)
        ._element("TicksAbove", D::ClassType::TicksAbove)
        ._element("TicksLeft", D::ClassType::TicksLeft)
        ._element("TicksBelow", D::ClassType::TicksBelow)
        ._element("TicksRight", D::ClassType::TicksRight)
        ._element("TicksBothSides", D::ClassType::TicksBothSides)
    ;
}


class QSliderWrapper : public QSlider, public cpgf::GScriptWrapper {
public:
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QSlider::qt_metacast(__arg0);
    }
    ...
    void super_paintEvent(QPaintEvent * ev)
    {
        QSlider::paintEvent(ev);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QSlider::qt_metacall(__arg0, __arg1, __arg2);
    }
...
template <typename D>
void buildMetaClass_QSliderWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    
    QSliderWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QSlider<D>(config, _d);
}
