...
#ifndef CPGF_META_QTWIDGETS_QFONTDIALOG_H
#define CPGF_META_QTWIDGETS_QFONTDIALOG_H
...
void buildMetaClass_QFontDialog(D _d)
{
    ...
    ;
    _d.CPGF_MD_TEMPLATE _constructor<void * (const QFont &, QWidget *)>(cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >())
        ._default(copyVariantFromCopyable(0))
    ;
    ...
    _d.CPGF_MD_TEMPLATE _method("selectedFont", &D::ClassType::selectedFont);
    ...
    _d.CPGF_MD_TEMPLATE _method("currentFontChanged", &D::ClassType::currentFontChanged, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >());
    _d.CPGF_MD_TEMPLATE _method("fontSelected", &D::ClassType::fontSelected, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >());
    _d.CPGF_MD_TEMPLATE _method("tr", &D::ClassType::tr)
        ._default(copyVariantFromCopyable(-1))
        ._default(copyVariantFromCopyable(0))
    ;
    _d.CPGF_MD_TEMPLATE _method("getFont", (QFont (*) (bool *, QWidget *))&D::ClassType::getFont)
        ._default(copyVariantFromCopyable(0))
    ;
    _d.CPGF_MD_TEMPLATE _method("getFont", (QFont (*) (bool *, const QFont &, QWidget *, const QString &, QFontDialog::FontDialogOptions))&D::ClassType::getFont, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<1>, cpgf::GMetaRuleCopyConstReference<3> >())
        ._default(copyVariantFromCopyable(0))
        ._default(copyVariantFromCopyable(QString()))
        ._default(copyVariantFromCopyable(0))
    ;
    _d.CPGF_MD_TEMPLATE _enum<typename D::ClassType::FontDialogOption>("FontDialogOption")
        ._element("NoButtons", D::ClassType::NoButtons)
        ._element("DontUseNativeDialog", D::ClassType::DontUseNativeDialog)
        ._element("ScalableFonts", D::ClassType::ScalableFonts)
        ._element("NonScalableFonts", D::ClassType::NonScalableFonts)
...
class QFontDialogWrapper : public QFontDialog, public cpgf::GScriptWrapper {
public:
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QFontDialog::qt_metacall(__arg0, __arg1, __arg2);
    }
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QFontDialog::qt_metacast(__arg0);
    }
