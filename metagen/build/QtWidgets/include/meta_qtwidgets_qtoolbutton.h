...
#ifndef __META_QTWIDGETS_QTOOLBUTTON_H
#define __META_QTWIDGETS_QTOOLBUTTON_H
...
template <typename D>
void buildMetaClass_QToolButton(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("arrowType", &D::ClassType::arrowType);
    _d.CPGF_MD_TEMPLATE _method("setArrowType", &D::ClassType::setArrowType);
    _d.CPGF_MD_TEMPLATE _method("setMenu", &D::ClassType::setMenu);
    _d.CPGF_MD_TEMPLATE _method("menu", &D::ClassType::menu);
    _d.CPGF_MD_TEMPLATE _method("setPopupMode", &D::ClassType::setPopupMode);
    _d.CPGF_MD_TEMPLATE _method("popupMode", &D::ClassType::popupMode);
    _d.CPGF_MD_TEMPLATE _method("defaultAction", &D::ClassType::defaultAction);
    _d.CPGF_MD_TEMPLATE _method("setAutoRaise", &D::ClassType::setAutoRaise);
    _d.CPGF_MD_TEMPLATE _method("autoRaise", &D::ClassType::autoRaise);
    _d.CPGF_MD_TEMPLATE _method("showMenu", &D::ClassType::showMenu);
    ...
    _d.CPGF_MD_TEMPLATE _method("tr", &D::ClassType::tr)
        ...
        ._default(copyVariantFromCopyable(0))
    ;
    _d.CPGF_MD_TEMPLATE _enum<typename D::ClassType::ToolButtonPopupMode>("ToolButtonPopupMode")
        ._element("DelayedPopup", D::ClassType::DelayedPopup)
        ._element("MenuButtonPopup", D::ClassType::MenuButtonPopup)
        ._element("InstantPopup", D::ClassType::InstantPopup)
    ;
}


class QToolButtonWrapper : public QToolButton, public cpgf::GScriptWrapper {
public:
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QToolButton::qt_metacast(__arg0);
    }
    ...
    bool super_hitButton(const QPoint & pos) const
    {
        return QToolButton::hitButton(pos);
    }
    ...
    void changeEvent(QEvent * __arg0)
    {
        ...
        QToolButton::changeEvent(__arg0);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QToolButton::qt_metacall(__arg0, __arg1, __arg2);
    }
    ...
    void actionEvent(QActionEvent * __arg0)
    {
        ...
        QToolButton::actionEvent(__arg0);
    }
    ...
    void mousePressEvent(QMouseEvent * __arg0)
    {
        ...
        QToolButton::mousePressEvent(__arg0);
    }
    ...
    void mouseReleaseEvent(QMouseEvent * __arg0)
    {
        ...
        QToolButton::mouseReleaseEvent(__arg0);
    }
    ...
    static void cpgf__register(const cpgf::GMetaDataConfigFlags & config, D _d)
    {
        ...
        _d.CPGF_MD_TEMPLATE _method("hitButton", (bool (D::ClassType::*) (const QPoint &) const)&D::ClassType::hitButton);
        _d.CPGF_MD_TEMPLATE _method("paintEvent", (void (D::ClassType::*) (QPaintEvent *))&D::ClassType::paintEvent);
        _d.CPGF_MD_TEMPLATE _method("checkStateSet", (void (D::ClassType::*) ())&D::ClassType::checkStateSet);
        ...
        _d.CPGF_MD_TEMPLATE _method("initStyleOption", (void (D::ClassType::*) (QStyleOptionToolButton *) const)&D::ClassType::initStyleOption);
        ...
        _d.CPGF_MD_TEMPLATE _method("super_nextCheckState", (void (D::ClassType::*) ())&D::ClassType::super_nextCheckState);
        ...
        _d.CPGF_MD_TEMPLATE _method("super_hitButton", (bool (D::ClassType::*) (const QPoint &) const)&D::ClassType::super_hitButton);
        _d.CPGF_MD_TEMPLATE _method("super_paintEvent", (void (D::ClassType::*) (QPaintEvent *))&D::ClassType::super_paintEvent);
        _d.CPGF_MD_TEMPLATE _method("super_checkStateSet", (void (D::ClassType::*) ())&D::ClassType::super_checkStateSet);
...
template <typename D>
void buildMetaClass_QToolButtonWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    
    QToolButtonWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QToolButton<D>(config, _d);
}
