...
#ifndef CPGF_META_QTWIDGETS_QTOOLBUTTON_H
#define CPGF_META_QTWIDGETS_QTOOLBUTTON_H
...
template <typename D>
void buildMetaClass_QToolButton(D _d)
{
    (void)_d;
...
template <typename D>
void buildMetaClass_QToolButtonWrapper(D _d)
{
    (void)_d;
    using namespace cpgf;
    
    
    QToolButtonWrapper::cpgf__register(_d);
    
    buildMetaClass_QToolButton<D>(_d);
}
