...
#ifndef __META_QTWIDGETS_QPROXYSTYLE_H
#define __META_QTWIDGETS_QPROXYSTYLE_H
...
public:
    ...
    QRect subElementRect(QStyle::SubElement element, const QStyleOption * option, const QWidget * widget) const
    {
        ...
        if(func)
        {
            return cpgf::fromVariant<QRect >(cpgf::invokeScriptFunction(func.get(), this, element, option, widget));
        }
    ...
    void drawPrimitive(QStyle::PrimitiveElement element, const QStyleOption * option, QPainter * painter, const QWidget * widget = 0) const
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunction(func.get(), this, element, option, painter, widget);
            return;
        }
    ...
    void drawComplexControl(QStyle::ComplexControl control, const QStyleOptionComplex * option, QPainter * painter, const QWidget * widget = 0) const
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunction(func.get(), this, control, option, painter, widget);
            return;
        }
    ...
    QStyle::SubControl hitTestComplexControl(QStyle::ComplexControl control, const QStyleOptionComplex * option, const QPoint & pos, const QWidget * widget = 0) const
    {
        ...
        if(func)
        {
            return cpgf::fromVariant<QStyle::SubControl >(cpgf::invokeScriptFunction(func.get(), this, control, option, pos, widget));
        }
    ...
    void polish(QPalette & pal)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunction(func.get(), this, pal);
            return;
        }
    ...
    int styleHint(QStyle::StyleHint hint, const QStyleOption * option = 0, const QWidget * widget = 0, QStyleHintReturn * returnData = 0) const
    {
        ...
        if(func)
        {
            return cpgf::fromVariant<int >(cpgf::invokeScriptFunction(func.get(), this, hint, option, widget, returnData));
        }
    ...
    QSize sizeFromContents(QStyle::ContentsType type, const QStyleOption * option, const QSize & size, const QWidget * widget) const
    {
        ...
        if(func)
        {
            return cpgf::fromVariant<QSize >(cpgf::invokeScriptFunction(func.get(), this, type, option, size, widget));
        }
