...
#ifndef CPGF_META_QTWIDGETS_QPUSHBUTTON_H
#define CPGF_META_QTWIDGETS_QPUSHBUTTON_H
...
void buildMetaClass_QPushButton(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _constructor<void * (const QString &, QWidget *)>(cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >())
        ._default(copyVariantFromCopyable(0))
    ;
    _d.CPGF_MD_TEMPLATE _constructor<void * (const QIcon &, const QString &, QWidget *)>(cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0>, cpgf::GMetaRuleCopyConstReference<1> >())
        ._default(copyVariantFromCopyable(0))
    ;
    ...
    _d.CPGF_MD_TEMPLATE _method("autoDefault", &D::ClassType::autoDefault);
    _d.CPGF_MD_TEMPLATE _method("setAutoDefault", &D::ClassType::setAutoDefault);
    _d.CPGF_MD_TEMPLATE _method("isDefault", &D::ClassType::isDefault);
    _d.CPGF_MD_TEMPLATE _method("setDefault", &D::ClassType::setDefault);
    _d.CPGF_MD_TEMPLATE _method("setMenu", &D::ClassType::setMenu);
    _d.CPGF_MD_TEMPLATE _method("menu", &D::ClassType::menu);
    _d.CPGF_MD_TEMPLATE _method("setFlat", &D::ClassType::setFlat);
    _d.CPGF_MD_TEMPLATE _method("isFlat", &D::ClassType::isFlat);
...
class QPushButtonWrapper : public QPushButton, public cpgf::GScriptWrapper {
public:
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QPushButton::qt_metacall(__arg0, __arg1, __arg2);
    }
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QPushButton::qt_metacast(__arg0);
    }
    ...
    static void cpgf__register(D _d)
    {
        ...
        _d.CPGF_MD_TEMPLATE _method("initStyleOption", (void (D::ClassType::*) (QStyleOptionButton *) const)&D::ClassType::initStyleOption);
