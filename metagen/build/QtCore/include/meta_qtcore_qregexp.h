...
#ifndef __META_QTCORE_QREGEXP_H
#define __META_QTCORE_QREGEXP_H
...
void buildMetaClass_Global_qregexp(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _operator<QDataStream& (*)(QDataStream &, QRegExp &)>(mopHolder >> mopHolder, cpgf::MakePolicy<cpgf::GMetaRuleParamNoncopyable<0> >());
