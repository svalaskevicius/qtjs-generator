...
#ifndef __META_QTCORE_QPLUGINLOADER_H
#define __META_QTCORE_QPLUGINLOADER_H
...
template <typename D>
void buildMetaClass_QPluginLoader(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("tr", &D::ClassType::tr)
        ...
        ._default(copyVariantFromCopyable(0))
    ;
    _d.CPGF_MD_TEMPLATE _method("staticInstances", &D::ClassType::staticInstances);
    _d.CPGF_MD_TEMPLATE _method("staticPlugins", &D::ClassType::staticPlugins);
}


class QPluginLoaderWrapper : public QPluginLoader, public cpgf::GScriptWrapper {
public:
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QPluginLoader::qt_metacall(__arg0, __arg1, __arg2);
    }
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QPluginLoader::qt_metacast(__arg0);
    }
...
template <typename D>
void buildMetaClass_QPluginLoaderWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    
    QPluginLoaderWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QPluginLoader<D>(config, _d);
}
