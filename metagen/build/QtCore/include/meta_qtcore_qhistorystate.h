...
#ifndef CPGF_META_QTCORE_QHISTORYSTATE_H
#define CPGF_META_QTCORE_QHISTORYSTATE_H
...
void buildMetaClass_QHistoryState(D _d)
{
    ...
    ;
    _d.CPGF_MD_TEMPLATE _constructor<void * (QHistoryState::HistoryType, QState *)>()
        ._default(copyVariantFromCopyable(0))
    ;
    ...
    _d.CPGF_MD_TEMPLATE _method("defaultState", &D::ClassType::defaultState);
    _d.CPGF_MD_TEMPLATE _method("setDefaultState", &D::ClassType::setDefaultState);
    _d.CPGF_MD_TEMPLATE _method("historyType", &D::ClassType::historyType);
    _d.CPGF_MD_TEMPLATE _method("setHistoryType", &D::ClassType::setHistoryType);
    _d.CPGF_MD_TEMPLATE _method("tr", &D::ClassType::tr)
        ._default(copyVariantFromCopyable(-1))
        ._default(copyVariantFromCopyable(0))
    ;
    _d.CPGF_MD_TEMPLATE _enum<typename D::ClassType::HistoryType>("HistoryType")
        ._element("ShallowHistory", D::ClassType::ShallowHistory)
        ._element("DeepHistory", D::ClassType::DeepHistory)
    ;
}


class QHistoryStateWrapper : public QHistoryState, public cpgf::GScriptWrapper {
public:
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QHistoryState::qt_metacast(__arg0);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QHistoryState::qt_metacall(__arg0, __arg1, __arg2);
    }
