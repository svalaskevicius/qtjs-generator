...
#ifndef __META_QTCORE_QITEMSELECTIONMODEL_H
...
public:
    ...
    void select(const QModelIndex & index, QItemSelectionModel::SelectionFlags command)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunction(func.get(), this, index, command);
            return;
        }
    ...
    void select(const QItemSelection & selection, QItemSelectionModel::SelectionFlags command)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunction(func.get(), this, selection, command);
            return;
        }
