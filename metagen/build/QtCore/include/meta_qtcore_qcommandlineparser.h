...
#ifndef __META_QTCORE_QCOMMANDLINEPARSER_H
#define __META_QTCORE_QCOMMANDLINEPARSER_H
...
template <typename D>
void buildMetaClass_QCommandLineParser(const cpgf::GMetaDataConfigFlags & config, D _d)
{
