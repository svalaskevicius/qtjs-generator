...
#ifndef __META_QTCORE_QMESSAGEAUTHENTICATIONCODE_H
#define __META_QTCORE_QMESSAGEAUTHENTICATIONCODE_H
...
template <typename D>
void buildMetaClass_QMessageAuthenticationCode(const cpgf::GMetaDataConfigFlags & config, D _d)
{
