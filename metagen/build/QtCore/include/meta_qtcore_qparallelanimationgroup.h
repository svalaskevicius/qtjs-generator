...
#ifndef __META_QTCORE_QPARALLELANIMATIONGROUP_H
#define __META_QTCORE_QPARALLELANIMATIONGROUP_H
...
template <typename D>
void buildMetaClass_QParallelAnimationGroup(const cpgf::GMetaDataConfigFlags & config, D _d)
{
...
class QParallelAnimationGroupWrapper : public QParallelAnimationGroup, public cpgf::GScriptWrapper {
public:
    ...
    void updateCurrentTime(int currentTime)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunction(func.get(), this, currentTime);
            return;
        }
        QParallelAnimationGroup::updateCurrentTime(currentTime);
    }
    void super_updateCurrentTime(int currentTime)
    {
        QParallelAnimationGroup::updateCurrentTime(currentTime);
    }
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QParallelAnimationGroup::qt_metacast(__arg0);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QParallelAnimationGroup::qt_metacall(__arg0, __arg1, __arg2);
    }
...
template <typename D>
void buildMetaClass_QParallelAnimationGroupWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    
    QParallelAnimationGroupWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QParallelAnimationGroup<D>(config, _d);
}
