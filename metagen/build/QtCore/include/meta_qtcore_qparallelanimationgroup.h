...
#ifndef CPGF_META_QTCORE_QPARALLELANIMATIONGROUP_H
#define CPGF_META_QTCORE_QPARALLELANIMATIONGROUP_H
...
template <typename D>
void buildMetaClass_QParallelAnimationGroup(D _d)
{
    (void)_d;
...
public:
    ...
    void updateCurrentTime(int currentTime)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunctionOnObject(func.get(), this, currentTime);
            return;
        }
...
template <typename D>
void buildMetaClass_QParallelAnimationGroupWrapper(D _d)
{
    (void)_d;
    using namespace cpgf;
    
    
    QParallelAnimationGroupWrapper::cpgf__register(_d);
    
    buildMetaClass_QParallelAnimationGroup<D>(_d);
}
