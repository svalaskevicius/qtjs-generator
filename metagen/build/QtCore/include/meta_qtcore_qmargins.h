...
#ifndef __META_QTCORE_QMARGINS_H
#define __META_QTCORE_QMARGINS_H
...
void buildMetaClass_Global_qmargins(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _operator<QDataStream& (*)(QDataStream &, QMargins &)>(mopHolder >> mopHolder, cpgf::MakePolicy<cpgf::GMetaRuleParamNoncopyable<0> >());
