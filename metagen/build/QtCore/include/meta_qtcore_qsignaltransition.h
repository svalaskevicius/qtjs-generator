...
#ifndef CPGF_META_QTCORE_QSIGNALTRANSITION_H
#define CPGF_META_QTCORE_QSIGNALTRANSITION_H
...
void buildMetaClass_QSignalTransition(D _d)
{
    ...
    ;
    _d.CPGF_MD_TEMPLATE _constructor<void * (const QObject *, const char *, QState *)>()
        ._default(copyVariantFromCopyable(0))
    ;
    ...
    _d.CPGF_MD_TEMPLATE _method("senderObject", &D::ClassType::senderObject);
    _d.CPGF_MD_TEMPLATE _method("setSenderObject", &D::ClassType::setSenderObject);
    _d.CPGF_MD_TEMPLATE _method("signal", &D::ClassType::signal);
    _d.CPGF_MD_TEMPLATE _method("setSignal", &D::ClassType::setSignal, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >());
...
class QSignalTransitionWrapper : public QSignalTransition, public cpgf::GScriptWrapper {
public:
    
    QSignalTransitionWrapper(QState * sourceState = 0)
        : QSignalTransition(sourceState) {}
    
    QSignalTransitionWrapper(const QObject * sender, const char * signal, QState * sourceState = 0)
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QSignalTransition::qt_metacall(__arg0, __arg1, __arg2);
    }
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QSignalTransition::qt_metacast(__arg0);
    }
