...
#ifndef __META_QTCORE_QFINALSTATE_H
#define __META_QTCORE_QFINALSTATE_H
...
template <typename D>
void buildMetaClass_QFinalState(const cpgf::GMetaDataConfigFlags & config, D _d)
{
...
class QFinalStateWrapper : public QFinalState, public cpgf::GScriptWrapper {
public:
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QFinalState::qt_metacast(__arg0);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QFinalState::qt_metacall(__arg0, __arg1, __arg2);
    }
...
template <typename D>
void buildMetaClass_QFinalStateWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    
    QFinalStateWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QFinalState<D>(config, _d);
}
