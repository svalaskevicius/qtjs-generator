...
#ifndef __META_QTCORE_QEVENTTRANSITION_H
#define __META_QTCORE_QEVENTTRANSITION_H
...
template <typename D>
void buildMetaClass_QEventTransition(const cpgf::GMetaDataConfigFlags & config, D _d)
{
...
template <typename D>
void buildMetaClass_QEventTransitionWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    
    QEventTransitionWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QEventTransition<D>(config, _d);
}
