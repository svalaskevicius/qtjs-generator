...
#ifndef __META_QTQML_QQMLPROPERTYMAP_H
#define __META_QTQML_QQMLPROPERTYMAP_H
...
public:
    ...
    QVariant updateValue(const QString & key, const QVariant & input)
    {
        ...
        if(func)
        {
            return cpgf::fromVariant<QVariant >(cpgf::invokeScriptFunction(func.get(), this, key, input));
        }
