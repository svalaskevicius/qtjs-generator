...
#ifndef CPGF_META_QTQML_QQUICKWIDGET_H
#define CPGF_META_QTQML_QQUICKWIDGET_H
...
template <typename D>
void buildMetaClass_QQuickWidget(D _d)
{
    (void)_d;
    ...
    ;
    _d.CPGF_MD_TEMPLATE _constructor<void * (QQmlEngine *, QWidget *)>();
    _d.CPGF_MD_TEMPLATE _constructor<void * (const QUrl &, QWidget *)>(cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >())
        ._default(copyVariantFromCopyable(0))
    ;
...
class QQuickWidgetWrapper : public QQuickWidget, public cpgf::GScriptWrapper {
public:
    
    QQuickWidgetWrapper(QWidget * parent = 0)
        : QQuickWidget(parent) {}
    
    QQuickWidgetWrapper(QQmlEngine * engine, QWidget * parent)
        : QQuickWidget(engine, parent) {}
    
    QQuickWidgetWrapper(const QUrl & source, QWidget * parent = 0)
    ...
    void wheelEvent(QWheelEvent * __arg0)
    {
        ...
        QQuickWidget::wheelEvent(__arg0);
    }
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QQuickWidget::qt_metacast(__arg0);
    }
    ...
    void resizeEvent(QResizeEvent * __arg0)
    {
        ...
        QQuickWidget::resizeEvent(__arg0);
    }
    ...
    bool event(QEvent * __arg0)
    {
        ...
        return QQuickWidget::event(__arg0);
    }
    ...
    void timerEvent(QTimerEvent * __arg0)
    {
        ...
        QQuickWidget::timerEvent(__arg0);
    }
    ...
    void mouseDoubleClickEvent(QMouseEvent * __arg0)
    {
        ...
        QQuickWidget::mouseDoubleClickEvent(__arg0);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QQuickWidget::qt_metacall(__arg0, __arg1, __arg2);
    }
    ...
    void mouseMoveEvent(QMouseEvent * __arg0)
    {
        ...
        QQuickWidget::mouseMoveEvent(__arg0);
    }
    ...
    void keyPressEvent(QKeyEvent * __arg0)
    {
        ...
        QQuickWidget::keyPressEvent(__arg0);
    }
    ...
    void mousePressEvent(QMouseEvent * __arg0)
    {
        ...
        QQuickWidget::mousePressEvent(__arg0);
    }
    ...
    void keyReleaseEvent(QKeyEvent * __arg0)
    {
        ...
        QQuickWidget::keyReleaseEvent(__arg0);
    }
    ...
    void mouseReleaseEvent(QMouseEvent * __arg0)
    {
        ...
        QQuickWidget::mouseReleaseEvent(__arg0);
    }
...
template <typename D>
void buildMetaClass_QQuickWidgetWrapper(D _d)
{
    (void)_d;
    using namespace cpgf;
    
    
    QQuickWidgetWrapper::cpgf__register(_d);
    
    buildMetaClass_QQuickWidget<D>(_d);
}
