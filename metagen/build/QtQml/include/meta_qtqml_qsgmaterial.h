...
#ifndef __META_QTQML_QSGMATERIAL_H
...
template <typename D>
void buildMetaClass_QSGMaterial(const cpgf::GMetaDataConfigFlags & config, D _d)
{
...
template <typename D>
void buildMetaClass_QSGMaterialWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
...
template <typename D>
void buildMetaClass_QSGMaterialShader(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
...
public:
    ...
    void updateState(const QSGMaterialShader::RenderState& state, QSGMaterial * newMaterial, QSGMaterial * oldMaterial)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunction(func.get(), this, state, newMaterial, oldMaterial);
            return;
        }
...
template <typename D>
void buildMetaClass_QSGMaterialShaderWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
...
template <typename D>
void buildMetaClass_QSGMaterialType(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
