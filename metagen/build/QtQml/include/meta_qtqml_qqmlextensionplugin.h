...
#ifndef __META_QTQML_QQMLEXTENSIONPLUGIN_H
#define __META_QTQML_QQMLEXTENSIONPLUGIN_H
...
template <typename D>
void buildMetaClass_QQmlExtensionPlugin(const cpgf::GMetaDataConfigFlags & config, D _d)
{
...
class QQmlExtensionPluginWrapper : public QQmlExtensionPlugin, public cpgf::GScriptWrapper {
public:
    
    QQmlExtensionPluginWrapper(QObject * parent = 0)
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QQmlExtensionPlugin::qt_metacast(__arg0);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QQmlExtensionPlugin::qt_metacall(__arg0, __arg1, __arg2);
    }
...
template <typename D>
void buildMetaClass_QQmlExtensionPluginWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    ...
    QQmlExtensionPluginWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QQmlExtensionPlugin<D>(config, _d);
}
