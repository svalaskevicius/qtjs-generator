...
#ifndef CPGF_META_QTQML_QSGTEXTUREPROVIDER_H
#define CPGF_META_QTQML_QSGTEXTUREPROVIDER_H
...
void buildMetaClass_QSGTextureProvider(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("textureChanged", &D::ClassType::textureChanged);
...
class QSGTextureProviderWrapper : public QSGTextureProvider, public cpgf::GScriptWrapper {
public:
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QSGTextureProvider::qt_metacast(__arg0);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QSGTextureProvider::qt_metacall(__arg0, __arg1, __arg2);
    }
    ...
    QSGTexture * texture() const
    {
        ...
        if(func)
        {
            return cpgf::fromVariant<QSGTexture * >(cpgf::invokeScriptFunction(func.get(), this).getValue());
        }
