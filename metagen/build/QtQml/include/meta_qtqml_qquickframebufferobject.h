...
#ifndef CPGF_META_QTQML_QQUICKFRAMEBUFFEROBJECT_H
#define CPGF_META_QTQML_QQUICKFRAMEBUFFEROBJECT_H
...
template <typename D>
void buildMetaClass_QQuickFramebufferObject(D _d)
{
    (void)_d;
    ...
    _d.CPGF_MD_TEMPLATE _method("textureFollowsItemSize", &D::ClassType::textureFollowsItemSize);
    _d.CPGF_MD_TEMPLATE _method("setTextureFollowsItemSize", &D::ClassType::setTextureFollowsItemSize);
    _d.CPGF_MD_TEMPLATE _method("createRenderer", &D::ClassType::createRenderer);
    _d.CPGF_MD_TEMPLATE _method("tr", &D::ClassType::tr)
        ._default(copyVariantFromCopyable(-1))
        ._default(copyVariantFromCopyable(0))
    ;
    {
        GDefineMetaClass<QQuickFramebufferObject::Renderer> _nd = GDefineMetaClass<QQuickFramebufferObject::Renderer>::Policy<MakePolicy<GMetaRuleDestructorAbsent, GMetaRuleDefaultConstructorAbsent, GMetaRuleDefaultConstructorAbsent, GMetaRuleCopyConstructorAbsent> >::declare("Renderer");
        _d.CPGF_MD_TEMPLATE _class(_nd);
    }
}


class QQuickFramebufferObjectWrapper : public QQuickFramebufferObject, public cpgf::GScriptWrapper {
public:
    
    QQuickFramebufferObjectWrapper(QQuickItem * parent = 0)
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QQuickFramebufferObject::qt_metacast(__arg0);
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QQuickFramebufferObject::qt_metacall(__arg0, __arg1, __arg2);
    }
    ...
    {
        cpgf::GScopedInterface<cpgf::IScriptFunction> func(this->getScriptFunction("createRenderer"));
        if(func)
        {
            return cpgf::fromVariant<QQuickFramebufferObject::Renderer* >(cpgf::invokeScriptFunction(func.get(), this).getValue());
        }
        throw std::runtime_error("Abstract method");
    }
    QQuickFramebufferObject::Renderer* super_createRenderer() const
    {
        throw std::runtime_error("Abstract method");
    }
    ...
    QSGNode * updatePaintNode(QSGNode * __arg0, QQuickItem::UpdatePaintNodeData * __arg1)
    {
        ...
        if(func)
        {
            return cpgf::fromVariant<QSGNode * >(cpgf::invokeScriptFunction(func.get(), this, __arg0, __arg1).getValue());
        }
        return QQuickFramebufferObject::updatePaintNode(__arg0, __arg1);
    }
    ...
    void textureFollowsItemSizeChanged(bool __arg0)
    {
        QQuickFramebufferObject::textureFollowsItemSizeChanged(__arg0);
    }
    ...
    static void cpgf__register(D _d)
    {
        ...
        _d.CPGF_MD_TEMPLATE _method("textureFollowsItemSizeChanged", (void (D::ClassType::*) (bool))&D::ClassType::textureFollowsItemSizeChanged);
        ...
        _d.CPGF_MD_TEMPLATE _method("super_createRenderer", (QQuickFramebufferObject::Renderer* (D::ClassType::*) () const)&D::ClassType::super_createRenderer);
...
template <typename D>
void buildMetaClass_QQuickFramebufferObjectWrapper(D _d)
{
    (void)_d;
    using namespace cpgf;
    ...
    QQuickFramebufferObjectWrapper::cpgf__register(_d);
    
    buildMetaClass_QQuickFramebufferObject<D>(_d);
}
