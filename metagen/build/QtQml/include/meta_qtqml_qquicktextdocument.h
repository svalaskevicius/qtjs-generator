...
#ifndef __META_QTQML_QQUICKTEXTDOCUMENT_H
#define __META_QTQML_QQUICKTEXTDOCUMENT_H
...
template <typename D>
void buildMetaClass_QQuickTextDocument(const cpgf::GMetaDataConfigFlags & config, D _d)
{
...
class QQuickTextDocumentWrapper : public QQuickTextDocument, public cpgf::GScriptWrapper {
public:
    
    QQuickTextDocumentWrapper(QQuickItem * parent)
        : QQuickTextDocument(parent) {}
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QQuickTextDocument::qt_metacall(__arg0, __arg1, __arg2);
    }
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QQuickTextDocument::qt_metacast(__arg0);
    }
...
template <typename D>
void buildMetaClass_QQuickTextDocumentWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    
    QQuickTextDocumentWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QQuickTextDocument<D>(config, _d);
}
