...
#ifndef CPGF_META_QTQML_QQUICKBEHAVIOR_P_H
#define CPGF_META_QTQML_QQUICKBEHAVIOR_P_H
...
template <typename D>
void buildMetaClass_QQuickBehavior(D _d)
{
    (void)_d;
    ...
    _d.CPGF_MD_TEMPLATE _method("write", &D::ClassType::write, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >());
    _d.CPGF_MD_TEMPLATE _method("animation", &D::ClassType::animation);
...
class QQuickBehaviorWrapper : public QQuickBehavior, public cpgf::GScriptWrapper {
public:
    
    QQuickBehaviorWrapper(QObject * parent = 0)
        : QQuickBehavior(parent) {}
    ...
    void setTarget(const QQmlProperty & __arg0)
    {
        ...
        QQuickBehavior::setTarget(__arg0);
    }
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QQuickBehavior::qt_metacast(__arg0);
    }
    ...
    void write(const QVariant & value)
    {
        ...
        QQuickBehavior::write(value);
    }
    void super_write(const QVariant & value)
    {
        QQuickBehavior::write(value);
    }
    ...
    const QMetaObject * metaObject() const
    {
        ...
        return QQuickBehavior::metaObject();
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QQuickBehavior::qt_metacall(__arg0, __arg1, __arg2);
    }
    ...
    static void cpgf__register(D _d)
    {
        ...
        _d.CPGF_MD_TEMPLATE _method("super_write", (void (D::ClassType::*) (const QVariant &))&D::ClassType::super_write, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >());
...
template <typename D>
void buildMetaClass_QQuickBehaviorWrapper(D _d)
{
    (void)_d;
    using namespace cpgf;
    
    
    QQuickBehaviorWrapper::cpgf__register(_d);
    
    buildMetaClass_QQuickBehavior<D>(_d);
}
