...
#ifndef CPGF_META_QTQML_QQMLABSTRACTURLINTERCEPTOR_H
#define CPGF_META_QTQML_QQMLABSTRACTURLINTERCEPTOR_H
...
public:
    ...
    QUrl intercept(const QUrl & path, QQmlAbstractUrlInterceptor::DataType type)
    {
        ...
        if(func)
        {
            return cpgf::fromVariant<QUrl >(cpgf::invokeScriptFunctionOnObject(func.get(), this, path, type).getValue());
        }
