...
#include "QtQuickParticles/5.3.1/QtQuickParticles/private/qquickwander_p.h"

#include "meta_qtqml_qquickwander_p.h"
...
GDefineMetaInfo createMetaClass_WanderData()
{
    ...
    {
        GDefineMetaClass<WanderData> _nd = GDefineMetaClass<WanderData>::lazyDeclare("WanderData", &buildMetaClass_WanderData);
        _d._class(_nd);
    }
