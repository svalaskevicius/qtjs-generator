...
#include "QtQml/5.3.2/QtQml/private/qhashfield_p.h"

#include "meta_qtqml_qhashfield_p.h"
...
GDefineMetaInfo createMetaClass_QHashField()
{
    ...
    {
        GDefineMetaClass<QHashField> _nd = GDefineMetaClass<QHashField>::lazyDeclare("QHashField", &buildMetaClass_QHashField);
        _d._class(_nd);
    }
