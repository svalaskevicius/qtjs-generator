...
#include <QtQuick/5.3.0/QtQuick/private/qsgdepthstencilbuffer_p.h>

#include "meta_qtqml_qsgdepthstencilbuffer_p.h"
...
GDefineMetaInfo createMetaClass_Global_qsgdepthstencilbuffer_p()
{
    ...
    buildMetaClass_Global_qsgdepthstencilbuffer_p(_d);
