...
#include "QtQuick/5.3.1/QtQuick/private/qquickwindow_p.h"
...
GDefineMetaInfo createMetaClass_QQuickCloseEvent()
{
    ...
    {
        GDefineMetaClass<QQuickCloseEvent, QObject> _nd = GDefineMetaClass<QQuickCloseEvent, QObject>::Policy<MakePolicy<GMetaRuleCopyConstructorAbsent> >::lazyDeclare("QQuickCloseEvent", &buildMetaClass_QQuickCloseEvent);
        _d._class(_nd);
    }
    {
