...
#include <QtQuick/5.3.0/QtQuick/private/qsggeometry_p.h>

#include "meta_qtqml_qsggeometry_p.h"
...
GDefineMetaInfo createMetaClass_QSGGeometryData()
{
    ...
    {
        GDefineMetaClass<QSGGeometryData> _nd = GDefineMetaClass<QSGGeometryData>::lazyDeclare("QSGGeometryData", &buildMetaClass_QSGGeometryData);
        _d._class(_nd);
    }
