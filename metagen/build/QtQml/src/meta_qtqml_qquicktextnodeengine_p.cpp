...
#include <QtQuick/5.2.1/QtQuick/private/qquicktextnodeengine_p.h>

#include "meta_qtqml_qquicktextnodeengine_p.h"
...
GDefineMetaInfo createMetaClass_Global_qquicktextnodeengine_p()
{
    ...
    buildMetaClass_Global_qquicktextnodeengine_p(_d);
