...
#include "QtQml/5.3.2/QtQml/private/qrecursionwatcher_p.h"

#include "meta_qtqml_qrecursionwatcher_p.h"
...
GDefineMetaInfo createMetaClass_QRecursionNode()
{
    ...
    {
        GDefineMetaClass<QRecursionNode> _nd = GDefineMetaClass<QRecursionNode>::lazyDeclare("QRecursionNode", &buildMetaClass_QRecursionNode);
        _d._class(_nd);
    }
