...
#include <QtQuick/5.3.0/QtQuick/private/qquickpixmapcache_p.h>
...
GDefineMetaInfo createMetaClass_QQuickPixmap()
{
    ...
    {
        GDefineMetaClass<QQuickPixmap> _nd = GDefineMetaClass<QQuickPixmap>::Policy<MakePolicy<GMetaRuleCopyConstructorAbsent> >::lazyDeclare("QQuickPixmap", &buildMetaClass_QQuickPixmap);
        _d._class(_nd);
    }
