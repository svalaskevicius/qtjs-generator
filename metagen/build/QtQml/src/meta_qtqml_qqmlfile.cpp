...
GDefineMetaInfo createMetaClass_QQmlFile()
{
    ...
    {
        GDefineMetaClass<QQmlFile> _nd = GDefineMetaClass<QQmlFile>::Policy<MakePolicy<GMetaRuleCopyConstructorAbsent> >::lazyDeclare("QQmlFile", &buildMetaClass_QQmlFile);
        _d._class(_nd);
    }
