...
#ifndef __META_QTGUI_QPAGEDPAINTDEVICE_H
#define __META_QTGUI_QPAGEDPAINTDEVICE_H
...
template <typename D>
void buildMetaClass_QPagedPaintDevice(const cpgf::GMetaDataConfigFlags & config, D _d)
{
...
public:
    ...
    void setPageSizeMM(const QSizeF & size)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunction(func.get(), this, size);
            return;
        }
    ...
    void setMargins(const QPagedPaintDevice::Margins& margins)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunction(func.get(), this, margins);
            return;
        }
...
template <typename D>
void buildMetaClass_QPagedPaintDeviceWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
