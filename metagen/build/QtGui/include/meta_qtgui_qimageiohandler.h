...
public:
    ...
    bool supportsOption(QImageIOHandler::ImageOption option) const
    {
        ...
        if(func)
        {
            return cpgf::fromVariant<bool >(cpgf::invokeScriptFunctionOnObject(func.get(), this, option).getValue());
        }
    ...
    void setOption(QImageIOHandler::ImageOption option, const QVariant & value)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunctionOnObject(func.get(), this, option, value);
            return;
        }
    ...
    QVariant option(QImageIOHandler::ImageOption option) const
    {
        ...
        if(func)
        {
            return cpgf::fromVariant<QVariant >(cpgf::invokeScriptFunctionOnObject(func.get(), this, option).getValue());
        }
