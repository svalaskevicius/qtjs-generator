...
#ifndef CPGF_META_QTGUI_QTEXTLIST_H
#define CPGF_META_QTGUI_QTEXTLIST_H
...
void buildMetaClass_QTextList(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("itemNumber", &D::ClassType::itemNumber);
...
class QTextListWrapper : public QTextList, public cpgf::GScriptWrapper {
public:
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QTextList::qt_metacast(__arg0);
    }
    ...
    void blockRemoved(const QTextBlock & block)
    {
        ...
        if(func)
        {
            cpgf::invokeScriptFunction(func.get(), this, block);
            return;
        }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QTextList::qt_metacall(__arg0, __arg1, __arg2);
    }
