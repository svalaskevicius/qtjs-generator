...
#ifndef CPGF_META_QTGUI_QGENERICPLUGIN_H
#define CPGF_META_QTGUI_QGENERICPLUGIN_H
...
class QGenericPluginWrapper : public QGenericPlugin, public cpgf::GScriptWrapper {
public:
    
    QGenericPluginWrapper(QObject * parent = 0)
    ...
    QObject * create(const QString & name, const QString & spec)
    {
        ...
        if(func)
        {
            return cpgf::fromVariant<QObject * >(cpgf::invokeScriptFunctionOnObject(func.get(), this, name, spec).getValue());
        }
        throw std::runtime_error("Abstract method");
    }
    QObject * super_create(const QString & name, const QString & spec)
    {
        throw std::runtime_error("Abstract method");
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QGenericPlugin::qt_metacall(__arg0, __arg1, __arg2);
    }
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QGenericPlugin::qt_metacast(__arg0);
    }
    ...
    static void cpgf__register(D _d)
    {
        ...
        _d.CPGF_MD_TEMPLATE _method("super_create", (QObject * (D::ClassType::*) (const QString &, const QString &))&D::ClassType::super_create, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0>, cpgf::GMetaRuleCopyConstReference<1> >());
