...
#ifndef __META_QTGUI_QSTYLEHINTS_H
#define __META_QTGUI_QSTYLEHINTS_H
...
template <typename D>
void buildMetaClass_QStyleHints(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _method("passwordMaskCharacter", &D::ClassType::passwordMaskCharacter);
    _d.CPGF_MD_TEMPLATE _method("fontSmoothingGamma", &D::ClassType::fontSmoothingGamma);
    _d.CPGF_MD_TEMPLATE _method("useRtlExtensions", &D::ClassType::useRtlExtensions);
    _d.CPGF_MD_TEMPLATE _method("setFocusOnTouchRelease", &D::ClassType::setFocusOnTouchRelease);
...
class QStyleHintsWrapper : public QStyleHints, public cpgf::GScriptWrapper {
public:
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QStyleHints::qt_metacall(__arg0, __arg1, __arg2);
    }
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QStyleHints::qt_metacast(__arg0);
    }
...
template <typename D>
void buildMetaClass_QStyleHintsWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    
    
    QStyleHintsWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QStyleHints<D>(config, _d);
}
