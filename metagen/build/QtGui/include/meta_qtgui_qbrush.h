...
#ifndef __META_QTGUI_QBRUSH_H
#define __META_QTGUI_QBRUSH_H
...
void buildMetaClass_Global_qbrush(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _operator<QDataStream& (*)(QDataStream &, QBrush &)>(mopHolder >> mopHolder, cpgf::MakePolicy<cpgf::GMetaRuleParamNoncopyable<0> >());
