...
#ifndef __META_QTGUI_QPICTUREFORMATPLUGIN_H
#define __META_QTGUI_QPICTUREFORMATPLUGIN_H
...
public:
    ...
    bool savePicture(const QString & format, const QString & filename, const QPicture & pic)
    {
        ...
        if(func)
        {
            return cpgf::fromVariant<bool >(cpgf::invokeScriptFunction(func.get(), this, format, filename, pic));
        }
    ...
    bool installIOHandler(const QString & format)
    {
        ...
        if(func)
        {
            return cpgf::fromVariant<bool >(cpgf::invokeScriptFunction(func.get(), this, format));
        }
