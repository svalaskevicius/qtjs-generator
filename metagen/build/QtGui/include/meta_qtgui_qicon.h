...
#ifndef __META_QTGUI_QICON_H
#define __META_QTGUI_QICON_H
...
void buildMetaClass_Global_qicon(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _operator<QDataStream& (*)(QDataStream &, QIcon &)>(mopHolder >> mopHolder, cpgf::MakePolicy<cpgf::GMetaRuleParamNoncopyable<0> >());
