...
#ifndef __META_QTGUI_QCURSOR_H
#define __META_QTGUI_QCURSOR_H
...
void buildMetaClass_Global_qcursor(D _d)
{
    ...
    _d.CPGF_MD_TEMPLATE _operator<QDataStream& (*)(QDataStream &, QCursor &)>(mopHolder >> mopHolder, cpgf::MakePolicy<cpgf::GMetaRuleParamNoncopyable<0> >());
