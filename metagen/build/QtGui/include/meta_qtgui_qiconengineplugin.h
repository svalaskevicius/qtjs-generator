...
#ifndef __META_QTGUI_QICONENGINEPLUGIN_H
#define __META_QTGUI_QICONENGINEPLUGIN_H
...
template <typename D>
void buildMetaClass_Global_qiconengineplugin(const cpgf::GMetaDataConfigFlags & config, D _d)
{
...
template <typename D>
void buildMetaClass_QIconEnginePlugin(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
...
class QIconEnginePluginWrapper : public QIconEnginePlugin, public cpgf::GScriptWrapper {
public:
    
    QIconEnginePluginWrapper(QObject * parent = 0)
    ...
    QIconEngine * create(const QString & filename = QString())
    {
        ...
        if(func)
        {
            return cpgf::fromVariant<QIconEngine * >(cpgf::invokeScriptFunction(func.get(), this, filename));
        }
        throw std::runtime_error("Abstract method");
    }
    QIconEngine * super_create(const QString & filename = QString())
    {
        throw std::runtime_error("Abstract method");
    }
    ...
    int qt_metacall(QMetaObject::Call __arg0, int __arg1, void ** __arg2)
    {
        ...
        return QIconEnginePlugin::qt_metacall(__arg0, __arg1, __arg2);
    }
    ...
    void * qt_metacast(const char * __arg0)
    {
        ...
        return QIconEnginePlugin::qt_metacast(__arg0);
    }
    ...
    static void cpgf__register(const cpgf::GMetaDataConfigFlags & config, D _d)
    {
        ...
        _d.CPGF_MD_TEMPLATE _method("super_create", (QIconEngine * (D::ClassType::*) (const QString &))&D::ClassType::super_create, cpgf::MakePolicy<cpgf::GMetaRuleCopyConstReference<0> >())
            ._default(copyVariantFromCopyable(QString()))
        ;
...
template <typename D>
void buildMetaClass_QIconEnginePluginWrapper(const cpgf::GMetaDataConfigFlags & config, D _d)
{
    (void)config; (void)_d; (void)_d;
    using namespace cpgf;
    ...
    QIconEnginePluginWrapper::cpgf__register(config, _d);
    
    buildMetaClass_QIconEnginePlugin<D>(config, _d);
}
